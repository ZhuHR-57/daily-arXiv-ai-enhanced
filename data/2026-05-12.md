...
### [4] [SAGE: Scalable Agentic Grounded Evaluation for Crop Disease Diagnosis](https://arxiv.org/abs/2605.09768)
...
### [5] [CalBench: Evaluating Coordination-Privacy Trade-offs in Multi-Agent LLMs](https://arxiv.org/abs/2605.09823)
...
### [6] [Skill Description Deception Attack against Task Routing in Internet of Agents](https://arxiv.org/abs/2605.09889)
...
### [7] [Safe Multi-Agent Behavior Must Be Maintained, Not Merely Asserted: Constraint Drift in LLM-Based Multi-Agent Systems](https://arxiv.org/abs/2605.10481)
...
### [8] [The Bystander Effect in Multi-Agent Reasoning: Quantifying Cognitive Loafing in Collaborative Interactions](https://arxiv.org/abs/2605.10698)
...
### [9] [Too Many Specialists: Emergent Inefficiencies and Bottlenecks for Multi-agent Ad-hoc Collaboration](https://arxiv.org/abs/2605.08540)
...
### [10] [Representations of 3D Rotations: Mathematical Foundations and Comparative Analysis](https://arxiv.org/abs/2605.08086)
...
### [11] [Explicit Inversion of Planar NURBS Curves](https://arxiv.org/abs/2605.08087)
...
### [12] [Alice v1: Distillation-Enhanced Video Generation Surpassing Closed-Source Models](https://arxiv.org/abs/2605.08115)
...
### [13] [CAGS: Color-Adaptive Volumetric Video Streaming with Dynamic 3D Gaussian Splatting](https://arxiv.org/abs/2605.09279)
...
### [14] [MeshFIM: Local Low-Poly Mesh Editing via Fill-in-the-Middle Autoregressive Generation](https://arxiv.org/abs/2605.08744)
...
### [15] [HairGPT: Strand-as-Language Autoregressive Modeling for Realistic 3D Hairstyle Synthesis](https://arxiv.org/abs/2605.08824)
...
### [16] [LagrangianSplats: Divergence-Free Transport of Gaussian Primitives for Fluid Reconstruction](https://arxiv.org/abs/2605.09299)
...
### [17] [FrameTwin: Curve-Anchored Gaussian Alignment from Sparse Views for Adaptive Wireframe 3D Printing](https://arxiv.org/abs/2605.09362)
...
### [18] [Geometrically Approximated Modeling for Emitter-Centric Ray-Triangle Filtering in Arbitrarily Dynamic LiDAR Simulation](https://arxiv.org/abs/2605.10457)
...
### [19] [Causal Stories from Sensor Traces: Auditing Epistemic Overreach in LLM-Generated Personal Sensing Explanations](https://arxiv.org/abs/2605.08590)
...
### [20] [Sycamore: Characterizing Synthetic Personas for Evaluating Genomics Visualization Retrieval](https://arxiv.org/abs/2605.08630)
...
### [21] [Fatigue-Related Reaction Time Forecasting via EEG Functional Connectivity in Sustained Attention Task](https://arxiv.org/abs/2605.08631)
*Bo Sun,Liang Ma*
...
### [22] [Fast-Food Intimacy: How Chinese Women Navigate Soul's AI Boyfriend](https://arxiv.org/abs/2605.08650)
...
### [23] [Rushed by Discomfort, Trapped by Immersion: Users' Experiences and Responses to Privacy Deceptive Design in Commercial VR Applications](https://arxiv.org/abs/2605.09198)
...
### [24] [Who embraces AI in play? Exploratory modeling of player preference profiles toward game AI](https://arxiv.org/abs/2605.09550)
...
### [25] [MiXR: Harvesting and Recomposing Geometry from Real-World Objects for In-Situ 3D Design](https://arxiv.org/abs/2605.09620)
...
### [26] [AwareLLM: A Proactive Multimodal Ecosystem for Personalized Human-AI Collaboration to Enhance Productivity](https://arxiv.org/abs/2605.09625)
...
### [27] [LLMs are the Ideal Candidate for Mixed-Initiative Game Design Pillar Workflows](https://arxiv.org/abs/2605.09767)
...
### [28] [Push and Pushback in Contesting AI: Demands for and Resistance to Accountability](https://arxiv.org/abs/2605.09793)
...
### [29] [Elemental Alchemist: A Generative Interface for Semantic Control of Particle Systems Across Dynamic Levels of Abstraction](https://arxiv.org/abs/2605.10014)
...
### [30] [Designing for Collective Access: In Search of a Solution to Accessible Communication in a Mixed-Ability Non-Profit](https://arxiv.org/abs/2605.10085)
...
### [31] [Mind Modeling: A ToM-Based Framework for Personalization](https://arxiv.org/abs/2605.10306)
*Cristina Gena*
...
### [32] [The Renaissance of Repair: A Timely Opportunity for Fabrication Research](https://arxiv.org/abs/2605.10450)
...
### [33] [The Balance between Nuance and Clarity: Decluttering Tabular Sequential Graphs to Counter Money Laundering](https://arxiv.org/abs/2605.10522)
...
### [34] [When Should Teachers Control AI Generation for Mathematics Visuals?](https://arxiv.org/abs/2605.10672)
...
### [35] [How Creatives Approach GenAI Image Generation: Tensions Between Structured Guidance, Self-Experimentation, and Creative Autonomy](https://arxiv.org/abs/2605.10898)
...
### [36] [Evaluating the False Trust engendered by LLM Explanations](https://arxiv.org/abs/2605.10930)
