...
### [3] [Indirect tipping: a social attack surface in AI agent populations](https://arxiv.org/abs/2609.25194)
...
### [4] [Tipping Points in LLM-Based Multi-Agent Systems: Stance on Climate Change Action](https://arxiv.org/abs/2609.25432)
...
### [5] [When Does Execution Provenance Help Agent Memory Retrieval?](https://arxiv.org/abs/2609.25913)
...
### [6] [Governed AI-Agent Coordination for Dementia Care: Architecture, Safety Contracts, and Evidence-Derived Workflow Verification](https://arxiv.org/abs/2609.25956)
...
### [7] [Calibration Is Not Verification: Falsifiability-Aware Conformal Routing for Mixture-of-Agents](https://arxiv.org/abs/2609.25959)
...
### [8] [MATES: Learning Multi-Agent Interactions by Transforming Observations for Frozen Single-Agent Policies](https://arxiv.org/abs/2609.26010)
...
### [9] [The Fleet Is the Model: Engineering Collective Intelligence with Fusion-MoA Pioneer R1](https://arxiv.org/abs/2609.26080)
...
### [10] [Behavior is Not Enough: A Mechanism-Based Evaluation of Social Norm Emergence in LLM Societies](https://arxiv.org/abs/2609.26481)
...
### [11] [CogenPVG: Cognitive-Enhanced Reflective Multi-Agent Framework for Persuasive Video Generation](https://arxiv.org/abs/2609.25821)
...
### [12] [TV-AudioRemover: Joint Text-Visual Guided Sound Removal with Multi-Task Hard-Mixture Curriculum](https://arxiv.org/abs/2609.25864)
...
### [13] [KeyBound: Keyed and Host-Bound Learned Audio Watermarking for Speech Provenance](https://arxiv.org/abs/2609.26235)
...
### [14] [ROAM-ASD: Robust Open-World Active Speaker Detection with Flexible Multimodal Fusion](https://arxiv.org/abs/2609.26648)
...
### [15] [How Children Design and Reason about Trustworthy AI Chatbots](https://arxiv.org/abs/2609.25244)
...
### [16] [A Case Study in Accessible Redesign of a Wastewater Dashboard](https://arxiv.org/abs/2609.25273)
...
### [17] [Can LLMs identify and repair ruptures? Comparison between clinician practices and LLM behaviors](https://arxiv.org/abs/2609.25287)
...
### [18] ["I Talked an AI Chatbot, So What's Next?" How U.S. Young Adults Imagine Responsible AI for Emotion Coping](https://arxiv.org/abs/2609.25311)
...
### [19] [Beyond Task Performance: Lessons Learned from Evaluating an Exploratory VR Interaction Technique](https://arxiv.org/abs/2609.25414)
...
### [20] [How Early Can You Tell? Early Eye Gaze Dynamics and Cybersickness Progression in Virtual Reality](https://arxiv.org/abs/2609.25422)
...
### [21] [When the Strike Zone Becomes Algorithmic: Umpire Judgment and Player Challenge Decisions under AI Review](https://arxiv.org/abs/2609.25525)
...
### [22] [Deflecting the Value Compass: Interacting with Large Language Models Temporarily Shifts Human Value Priorities Toward Personal Focus](https://arxiv.org/abs/2609.25586)
...
### [23] [SurgGaze: Implicit Calibration for Accurate Gaze Analysis in Operating Rooms with Wearable Eyetrackers](https://arxiv.org/abs/2609.25612)
...
### [24] [SurgGraph: Quantitative Laparoscopic Video Understanding via Geometry-Grounded Scene Graphs](https://arxiv.org/abs/2609.25651)
...
### [25] [Harnessing LLMs Without Surrendering Control: Delegation Boundaries in Visual Data Storytelling Authoring](https://arxiv.org/abs/2609.25700)
...
### [26] [The Impact of Deep Care Isa on Reducing Musculoskeletal Disorders and Enhancing Productivity Among Office Employees: A Comprehensive Study](https://arxiv.org/abs/2609.25883)
...
### [27] [Designing Task-Induced Arousal: A Multimodal Stress Induction Method for Interactive Experiments](https://arxiv.org/abs/2609.26156)
...
### [28] [TRACE: Transparent Retrieval for Abstract Concept Evaluation](https://arxiv.org/abs/2609.26168)
*Joseph Bingham*
...
### [29] [Beyond the Lab: Large-Scale Remote Cybersickness Research in Virtual Reality Using the VERA Platform](https://arxiv.org/abs/2609.26203)
...
### [30] [AI-Generated Email Drafts Shift Culturally Distinctive Communication Styles in Professional Email](https://arxiv.org/abs/2609.26403)
...
### [31] [Bespoke: Generating MOOC-Quality Industry-Personalized Lecture Videos at Scale](https://arxiv.org/abs/2609.26540)
...
### [32] [E3Sense: Head-Confined Multimodal Sensing of Learner Engagement](https://arxiv.org/abs/2609.26569)
...
### [33] [Stepping into the Margins: How Readers Want AI to Generate Footnotes](https://arxiv.org/abs/2609.26673)
...
### [34] [Does AI Save Time on Product Design? A Randomized Controlled Experiment of AI Prompt-to-Design Workflows](https://arxiv.org/abs/2609.26725)
