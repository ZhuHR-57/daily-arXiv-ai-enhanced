...
### [1] [AniGen: Unified $S^3$ Fields for Animatable 3D Asset Generation](https://arxiv.org/abs/2604.08746)
...
### [2] [MeshOn: Intersection-Free Mesh-to-Mesh Composition](https://arxiv.org/abs/2604.08799)
...
### [3] [Beyond the Individual: Virtualizing Multi-Disciplinary Reasoning for Clinical Intake via Collaborative Agents](https://arxiv.org/abs/2604.08927)
...
### [4] [Aligned Agents, Biased Swarm: Measuring Bias Amplification in Multi-Agent Systems](https://arxiv.org/abs/2604.08963)
...
### [5] [Multi-agent Reinforcement Learning for Low-Carbon P2P Energy Trading among Self-Interested Microgrids](https://arxiv.org/abs/2604.08973)
...
### [6] [Social Reality Construction via Active Inference: Modeling the Dialectic of Conformity and Creativity](https://arxiv.org/abs/2604.09026)
...
### [7] [Plasticity-Enhanced Multi-Agent Mixture of Experts for Dynamic Objective Adaptation in UAVs-Assisted Emergency Communication Networks](https://arxiv.org/abs/2604.09028)
...
### [8] [Risk-seeking conservative policy iteration with agent-state based policies for Dec-POMDPs with guaranteed convergence](https://arxiv.org/abs/2604.09495)
...
### [9] [TeamLLM: Exploring the Capabilities of LLMs for Multimodal Group Interaction Prediction](https://arxiv.org/abs/2604.08771)
...
### [10] [Semantic Zooming and Edge Bundling for Multi-Scale Supply Chain Flow Visualization](https://arxiv.org/abs/2604.08823)
...
### [11] [Enhance Comprehension of Over-the-Counter Drug Instructions for the General Public and Medical Professionals through Visualization Design](https://arxiv.org/abs/2604.09134)
...
### [12] [AI-Induced Human Responsibility (AIHR) in AI-Human teams](https://arxiv.org/abs/2604.08866)
...
### [13] [Omakase: proactive assistance with actionable suggestions for evolving scientific research projects](https://arxiv.org/abs/2604.08898)
...
### [14] [Lightweight and Generalizable Multi-Sensor Human Activity Recognition via Cascaded Fusion and Style-Augmented Decomposition](https://arxiv.org/abs/2604.08910)
...
### [15] [How Do LLMs See Charts? A Comparative Study on High-Level Visualization Comprehension in Humans and LLMs](https://arxiv.org/abs/2604.08959)
...
### [16] [Accessible Fine-grained Data Representation via Spatial Audio](https://arxiv.org/abs/2604.08979)
...
### [17] [The Speculative Future of Conversational AI for Neurocognitive Disorder Screening: a Multi-Stakeholder Perspective](https://arxiv.org/abs/2604.09070)
...
### [18] [What's in a BIP? Exploring the Lived Experiences of Breaks In Presence](https://arxiv.org/abs/2604.09146)
...
### [19] [Structuring versus Problematizing: How LLM-based Agents Scaffold Learning in Diagnostic Reasoning](https://arxiv.org/abs/2604.09158)
...
### [20] [LandSAR: Visceralizing Landslide Data for Enhanced Situational Awareness in Immersive Analytics](https://arxiv.org/abs/2604.09241)
...
### [21] [3D-Printing Water-Soluble Channels Filled with Liquid Metal for Recyclable and Cuttable Wireless Power Sheet](https://arxiv.org/abs/2604.09299)
...
### [22] [Three Modalities, Two Design Probes, One Prototype, and No Vision: Experience-Based Co-Design of a Multi-modal 3D Data Visualization Tool](https://arxiv.org/abs/2604.09426)
...
### [23] [Intent Lenses: Inferring Capture-Time Intent to Transform Opportunistic Photo Captures into Structured Visual Notes](https://arxiv.org/abs/2604.09438)
...
### [24] [Confidence Without Competence in AI-Assisted Knowledge Work](https://arxiv.org/abs/2604.09444)
...
### [25] [Demonstrably Informed Consent in Privacy Policy Flows: Evidence from a Randomized Experiment](https://arxiv.org/abs/2604.09518)
...
### [26] [qPRO-AQFP: Post-Routing Optimization of AQFP Circuits with Delay Line Clocking](https://arxiv.org/abs/2604.08705)
...
### [27] [A Physically-Informed Subgraph Isomorphism Approach to Molecular Docking Using Quantum Annealers](https://arxiv.org/abs/2604.09540)
...
### [28] [QoS-QoE Translation with Large Language Model](https://arxiv.org/abs/2604.08703)
...
### [29] [Generalizing Video DeepFake Detection by Self-generated Audio-Visual Pseudo-Fakes](https://arxiv.org/abs/2604.09110)
*Zihe Wei,Yuezun Li*
...
### [30] [2D or 3D: Who Governs Salience in VLA Models? -- Tri-Stage Token Pruning Framework with Modality Salience Awareness](https://arxiv.org/abs/2604.09244)
...
### [31] [Through Their Eyes: Fixation-aligned Tuning for Personalized User Emulation](https://arxiv.org/abs/2604.09368)
