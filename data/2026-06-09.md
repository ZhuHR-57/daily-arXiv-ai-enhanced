...
### [1] [Frequency-Scale Saliency for Spectral Descriptor Analysis in 3D Shape Retrieval](https://arxiv.org/abs/2606.07791)
*Jianru Shen*
...
### [2] [Wispy to Voluminous: Prior-free Multi-view Capture of Strand-level Facial Hair](https://arxiv.org/abs/2606.08041)
...
### [3] [OmniFaceRig: Fully Automatic Inner-Mouth-Aware Face Rigging Across Diverse 3D Character Topologies](https://arxiv.org/abs/2606.08043)
...
### [4] [MS-COOT: Comparing Morse-Smale Complexes with Co-Optimal Transport](https://arxiv.org/abs/2606.08258)
...
### [5] [OctaOctree Neural Radiosity for Real-time Glossy Material Rendering](https://arxiv.org/abs/2606.08469)
...
### [6] [The Minimal Retroreflective Microfacet Model](https://arxiv.org/abs/2606.08739)
...
### [7] [MaterialClusterGS: Palette-Based Material Decomposition and Physically-Based Relighting with 2D Gaussian Splatting](https://arxiv.org/abs/2606.09018)
...
### [8] [Path-Traced Inverse Rendering with Global Illumination in 3D Gaussian Fields](https://arxiv.org/abs/2606.09606)
...
### [9] [bbsolver: A Unified Error-Bounded Spatiotemporal Optimization Solver for Key Timing and Topology-Consistent Vector Paths](https://arxiv.org/abs/2606.09741)
*Ilya Gusinski*
...
### [10] [Conan-embedding-v3: Fusing Modality-Specific Models for Omni-Modal Embedding](https://arxiv.org/abs/2606.09331)
...
### [11] [LangRetrieval: Language-Guided Self-Evolving Satellite-to-Radar Retrieval via CSI-Driven Reward](https://arxiv.org/abs/2606.09486)
...
### [12] [What Went Wrong with Data Lakes? A 15-Year Reality Check from the Field](https://arxiv.org/abs/2606.08266)
*Youssef Gahi*
...
### [13] [xSense Design Cards: Guiding the Design of Multisensory Experiences](https://arxiv.org/abs/2606.08632)
...
### [14] [Silicon Photonics Testing: Design for Testability, Fault Detection, and Manufacturing Variation Analysis in Photonic Integrated Circuits](https://arxiv.org/abs/2606.08885)
...
### [15] [Symbolic Reasoning Frameworks Modulate LLM Risk Aversion in Multi-Agent Strategic Settings](https://arxiv.org/abs/2606.07552)
*Augustin Chan*
...
### [16] [GRPO Does Not Close the Multi-Agent Coordination Gap](https://arxiv.org/abs/2606.07845)
...
### [17] [EduMirror: Modeling Educational Social Dynamics with Value-driven Multi-agent Simulation](https://arxiv.org/abs/2606.07948)
...
### [18] [Voting Protocols as Coordination Mechanisms for Role-Constrained Multi-Agent Tutoring Systems](https://arxiv.org/abs/2606.08030)
...
### [19] [Silent Failure in LLM Agent Systems: The Entropy Principle and the Inevitable Disorder of Autonomous Agents](https://arxiv.org/abs/2606.08162)
*Dexing Liu*
...
### [20] [Toward Human-Centered Multi-Agent Systems: Integrating Cognition, Culture, Values, and Cooperation in AI Agents](https://arxiv.org/abs/2606.08274)
...
### [21] [Emergence World: A Platform for Evaluating Long-Horizon Multi-Agent Autonomy](https://arxiv.org/abs/2606.08367)
...
### [22] [The Consistency Illusion: How Multi-Agent Debate Hides Reasoning Misalignment](https://arxiv.org/abs/2606.08457)
...
### [23] [Is Telehealth Better Used to Treat Patients or Help Other Physicians Treat Patients? An Agent-Based Modeling Study of Healthcare Provision](https://arxiv.org/abs/2606.08701)
*Michael Chary*
...
### [24] [Performance Evaluation of Social Learning](https://arxiv.org/abs/2606.09176)
...
### [25] [Multimodal Large Language Models as Synthetic Participants in Video-Based Studies: An Evaluation](https://arxiv.org/abs/2606.07541)
...
### [26] [A Systematic Study of Behavioral Cloning for Scientific Data Annotation](https://arxiv.org/abs/2606.07568)
...
### [27] [TibetCPR: A Multimodal Tactile Feedback System to Enhance Cardiopulmonary Resuscitation Training in High-Altitude Regions of Tibet](https://arxiv.org/abs/2606.07765)
...
### [28] [Exploring Above-neck Unimanual Swipe Gestures for Off-Device Earable Interaction](https://arxiv.org/abs/2606.08198)
...
### [29] [Understanding Human and Interface Design Factors in Canadian Cybercrime Reporting](https://arxiv.org/abs/2606.07773)
...
### [30] [The Choreography of Augmented Reality Timelines: Studying the Relative Position, Chronology, & Situatedness of Event Sequences](https://arxiv.org/abs/2606.07794)
...
### [31] [Does Persona Make LLMs K-pop Fans? A Pilot Study of LLM-Based Online Concert Audience Agents](https://arxiv.org/abs/2606.07837)
...
### [32] [Automatic, Real-time Classification of User Feedback Using Large Language Models](https://arxiv.org/abs/2606.08050)
...
### [33] [How to be Non-Human : A Thematic Analysis of Animal Embodiment in VR Games](https://arxiv.org/abs/2606.08130)
...
### [34] [LCAM: A Framework for Diagnosing Interactional Alignment Failures in Con-versational AI](https://arxiv.org/abs/2606.08131)
...
### [35] [The Governance of Human-LLM Interaction: Safety Gating, Civility Steering, and Affective Default Lock-In](https://arxiv.org/abs/2606.08172)
...
### [36] ["So There's a Catch-22 Here": How Early Adopters Who Build Multi-Agent LLM Systems Conceptualize Transparency](https://arxiv.org/abs/2606.08323)
...
### [37] [CritLens: Visual Analytics for Criteria Discovery in Review-Based Decision Making](https://arxiv.org/abs/2606.08426)
...
### [38] [Comparing Controller-Free Pointing Techniques Across Depth for 2D Selection in Augmented Reality](https://arxiv.org/abs/2606.08441)
...
### [39] [Enhancing Presence, Deepening Fan Intensity: How Presence in Immersive Video Shapes Psychological Closeness to Performers](https://arxiv.org/abs/2606.08912)
...
### [40] [Vibe Visualizing: How Visualization Novices Try (and Fail) to Generate and Interpret Visualizations with Conversational AI](https://arxiv.org/abs/2606.08914)
...
### [41] [In-Situ Immersive Analytics Authoring through Ergonomic Keyboard Support](https://arxiv.org/abs/2606.08927)
...
### [42] [Before You Scroll Again: Predicting Regretful Social Media Sessions from In-the-Wild Contextual and Wearable Sensing](https://arxiv.org/abs/2606.08965)
...
### [43] [sketch-plot: Progressive Editing for Text-to-Image Academic Figures](https://arxiv.org/abs/2606.09171)
...
### [44] [Demonstrating chart-plot: Closing the Last Mile of Academic Chart Generation](https://arxiv.org/abs/2606.09174)
...
### [45] [DuplexOmni: Real-Time Listening, Seeing, Thinking, and Speaking for Full-Duplex Interaction](https://arxiv.org/abs/2606.09186)
...
### [46] [Conceptualising Reflective Use: Toward A Process Perspective On Human-AI Interaction](https://arxiv.org/abs/2606.09242)
...
### [47] [AI Assurance in UK Defence: Challenges in Operationalising JSP 936](https://arxiv.org/abs/2606.09414)
...
### [48] [Seeing the Hivemind: A Consensus-Aware Interaction Technique for Mitigating AI Homogenization](https://arxiv.org/abs/2606.09587)
...
### [49] [Cohort-based Semantic Labeling: AI-Enabled Recovery of Visualization Semantics from Deployed SVGs](https://arxiv.org/abs/2606.09782)
