...
### [1] [Ultra-fast Traffic Nowcasting and Control via Differentiable Agent-based Simulation](https://arxiv.org/abs/2603.25068)
...
### [2] [AD-CARE: A Guideline-grounded, Modality-agnostic LLM Agent for Real-world Alzheimer's Disease Diagnosis with Multi-cohort Assessment, Fairness Analysis, and Reader Study](https://arxiv.org/abs/2603.25322)
...
### [3] [Conchordal: Emergent Harmony via Direct Cognitive Coupling in a Psychoacoustic Landscape](https://arxiv.org/abs/2603.25637)
*Koichi Takahashi*
...
### [4] [Examining the Effect of Explanations of AI Privacy Redaction in AI-mediated Interactions](https://arxiv.org/abs/2603.24735)
...
### [5] [SABER: Spatial Attention, Brain, Extended Reality](https://arxiv.org/abs/2603.24830)
...
### [6] [Context-Mediated Domain Adaptation in Multi-Agent Sensemaking Systems](https://arxiv.org/abs/2603.24858)
...
### [7] [Gaze patterns predict preference and confidence in pairwise AI image evaluation](https://arxiv.org/abs/2603.24849)
...
### [8] [More Than "Means to an End": Supporting Reasoning with Transparently Designed AI Data Science Processes](https://arxiv.org/abs/2603.24877)
...
### [9] [Co-designing for the Triad: Design Considerations for Collaborative Decision-Making Technologies in Pediatric Chronic Care](https://arxiv.org/abs/2603.24993)
...
### [10] [Framing Data Choices: How Pre-Donation Exploration Design Influence Data Donation Behavior and Decision-Making](https://arxiv.org/abs/2603.24995)
...
### [11] [TopoPilot: Reliable Conversational Workflow Automation for Topological Data Analysis and Visualization](https://arxiv.org/abs/2603.25063)
...
### [12] [On-Demand Instructional Material Providing Agent Based on MLLM for Tutoring Support](https://arxiv.org/abs/2603.25195)
...
### [13] [Beyond Benchmarks: How Users Evaluate AI Chat Assistants](https://arxiv.org/abs/2603.25220)
...
### [14] [Understanding Newcomer Persistence in Social VR: A Case Study of VRChat](https://arxiv.org/abs/2603.25223)
...
### [15] [Does Explanation Correctness Matter? Linking Computational XAI Evaluation to Human Understanding](https://arxiv.org/abs/2603.25251)
...
### [16] [Visual or Textual: Effects of Explanation Format and Personal Characteristics on the Perception of Explanations in an Educational Recommender System](https://arxiv.org/abs/2603.25624)
...
### [17] [Clinician Perspectives on Type 1 Diabetes Guidelines and Glucose Data Interpretation](https://arxiv.org/abs/2603.25631)
...
### [18] [Characterization of Off-wafer Pulse Communication in BrainScaleS Neuromorphic System](https://arxiv.org/abs/2603.24854)
...
### [19] [EPAR: Electromagnetic Pathways to Architectural Reliability in Quantum Processors](https://arxiv.org/abs/2603.25671)
