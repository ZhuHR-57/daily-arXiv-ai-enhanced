...
### [1] [Scaling Behavior of Single LLM-Driven Multi-Agent Systems](https://arxiv.org/abs/2606.00655)
...
### [2] [Dynamic Coordination Strategy Selection for Enterprise Multi-Agent Systems](https://arxiv.org/abs/2606.00804)
*Thanh Luong Tuan*
...
### [3] [FinCom: A Financial Multi-Agent Demo with Disagree-or-Commit Deliberation](https://arxiv.org/abs/2606.00939)
...
### [4] [Coordinating Task Switching in a Robotics Multi-Agent System Using Behavior Trees](https://arxiv.org/abs/2606.01170)
...
### [5] [Multi-Agent Computer Use](https://arxiv.org/abs/2606.01533)
...
### [6] [Agent System Operations: Categorization, Challenges, and Future Directions](https://arxiv.org/abs/2606.01581)
...
### [7] [MetaForge: A Self-Evolving Multimodal Agent that Retrieves, Adapts, and Forges Tools On Demand](https://arxiv.org/abs/2606.01801)
...
### [8] [Dynamic Trust-Aware Sparse Communication Topology for LLM-Based Multi-Agent Consensus](https://arxiv.org/abs/2606.01828)
...
### [9] [From Global Policies to Local Strategies: Multi-Objective Optimization of Resource-Specific Handover Policies](https://arxiv.org/abs/2606.01857)
...
### [10] [RadioMaster: Multi-Agent System for Autonomous Radio Signal Generation](https://arxiv.org/abs/2606.01862)
...
### [11] [QoEReasoner: An Agentic Reasoning Framework for Automated and Explainable QoE Diagnosis in RANs](https://arxiv.org/abs/2606.01925)
...
### [12] [A Simple Hierarchical Causality Primer](https://arxiv.org/abs/2606.01979)
*Tim Gebbie*
...
### [13] [Agentic-J: An AI Agent for Biological Microscopy Image Analysis](https://arxiv.org/abs/2606.02080)
...
### [14] [A Game-Theoretic Decision Framework for Optimal Selection of Coordination Detection Methods in Multi-UAV Fleet Operations](https://arxiv.org/abs/2606.02383)
*Christian Manasseh*
...
### [17] [Shu Dao: A Calligraphy Score Framework Linking Calligraphy, Music, and Performance](https://arxiv.org/abs/2606.00001)
*Lican Huang*
...
### [18] [Navigating Culture in Smart Port Cities: Cultural Sensitivity and Digital Engagement Among Sailing Tourists in the Mediterranean](https://arxiv.org/abs/2606.00004)
...
### [19] [Know Your Author: Does the AI Penalty Hold in Short Fiction?](https://arxiv.org/abs/2606.00006)
...
### [20] [A Four-Tier Communication Architecture and Sim-to-Real Validation of a Graphical Open-Source Platform for Robotic Engineering Education](https://arxiv.org/abs/2606.00550)
...
### [21] [Empathic and agentic artificial intelligence in nursing: perspectives on a human-centered framework for cancer care navigation in the United States](https://arxiv.org/abs/2606.00010)
...
### [22] [RuleEdit: Failure-Guided Human-AI Model Editing with Prospective Impact Preview](https://arxiv.org/abs/2606.00011)
...
### [23] [Fostering Emotional Perspective-Taking: An Exploration of Affective Face-Tracking Interactions in the VR Narrative Rekindle](https://arxiv.org/abs/2606.02425)
...
### [24] [SortingHat: Redefining Operating Systems Education with a Tailored Digital Teaching Assistant](https://arxiv.org/abs/2606.00015)
...
### [25] [Examine Clinicians' Modification of Hedging Language in Ambient AI Documentation: A Comparative Study of AI Drafts and Final Notes](https://arxiv.org/abs/2606.00018)
...
### [26] [Understanding Stigmatizing Language in Clinical Documentation: A Paired Comparison of Ambient AI Drafts and Clinician Finalized Notes](https://arxiv.org/abs/2606.00019)
...
### [27] [Navigating Independence: A Survey of Visually Impaired People's Experiences and Needs](https://arxiv.org/abs/2606.00025)
...
### [28] [Redistributing Voice and Responsibility: AI in Relationship-Centred Care](https://arxiv.org/abs/2606.00028)
...
### [30] [The New Social Image: How AI Competency and AI Proactivity Influence Self- and Peer-Perceptions in the Workplace](https://arxiv.org/abs/2606.00182)
...
### [31] [Agentic Authoring of Interactive Multiview Visualizations in Genomics](https://arxiv.org/abs/2606.00370)
...
### [32] [Knowing When to Move: Evidence Accumulation Models of Human Behavior in Traffic](https://arxiv.org/abs/2606.00727)
...
### [33] [ErgoGlide: A Wearable Trackball Device for Ergonomic Text Entry in Virtual Reality](https://arxiv.org/abs/2606.00823)
...
### [34] [MIA: A Visual Analytics System for Multimodal Spectral Imaging Data](https://arxiv.org/abs/2606.00874)
...
### [35] [pcbGPT: Automatic PCB Schematic Synthesis from Natural Language Requirements](https://arxiv.org/abs/2606.01188)
...
### [36] [From Craft Practice to Aesthetic Cognition Transmission: Workflow Cognition Translation for AI-native Intangible Cultural Heritage Education](https://arxiv.org/abs/2606.01203)
*Annie Yuan*
...
### [37] [What LLMs Must Forget to Teach Effectively: A DIY Approach to Premodern Japanese Language Pedagogy](https://arxiv.org/abs/2606.01410)
...
### [38] [AutoBG: A Board Game Design Assistant with Interactive Ideation, Iterative Rulebook Generation, and Individualized Feedback](https://arxiv.org/abs/2606.01976)
...
### [39] [Respectful Things: Adding Social Intelligence to 'Smart' Devices](https://arxiv.org/abs/2606.02037)
...
### [40] [Overview of the ClinicalSkillQA 2026 Shared Task on Continuous Perception and Procedural Reasoning in Clinical Skill Assessment](https://arxiv.org/abs/2606.02082)
...
### [41] [Context-Aware Workflow Decomposition for Automated Mobile UI Annotation Using Multimodal Large Language Models](https://arxiv.org/abs/2606.02208)
...
### [42] [Guided Sensemaking: Agents in Collaborative Deliberation](https://arxiv.org/abs/2606.02260)
...
### [43] [Quantitative Movement Testing: Measuring Patient Movements from a Single Smartphone Video](https://arxiv.org/abs/2606.02301)
...
### [44] [PaintBench: Deterministic Evaluation of Precise Visual Editing](https://arxiv.org/abs/2606.00188)
...
### [45] [Subgrid Marching Tetrahedra](https://arxiv.org/abs/2606.00454)
...
### [46] [Directed Distance Fields for Constant-Time Ray Queries on Gaussian Splatting](https://arxiv.org/abs/2606.00817)
*Subhankar MIshra*
...
### [47] [Temporally-Aligned Evaluation for Audio-Driven Talking Head Generation](https://arxiv.org/abs/2606.01031)
...
### [48] [AlbedoEdit: Unified Instance-Level Video Editing with Albedo Guidance](https://arxiv.org/abs/2606.01362)
...
### [49] [MPMWorlds: Material-Point-Method Simulations for Inferring and Extrapolating Physical Dynamics](https://arxiv.org/abs/2606.01538)
...
### [50] [KDH-CAD: Knowledge-data hybrid CAD learning under data scarcity](https://arxiv.org/abs/2606.01702)
...
### [51] [MidSurfNet: Learnable Face Pairing and Interference Implicit Fields for Generalized Mid-surface Abstraction](https://arxiv.org/abs/2606.01891)
...
### [52] [Single-Line Drawing Generation via Semantics-Driven Optimization](https://arxiv.org/abs/2606.01910)
...
### [53] [Composable function systems as a general-purpose rendering framework](https://arxiv.org/abs/2606.02226)
*James Schloss*
