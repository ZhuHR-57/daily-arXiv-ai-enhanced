...
### [1] [SRA: Semantic Relation-Aware Flowchart Question Answering](https://arxiv.org/abs/2602.13771)
...
### [2] [InfoCIR: Multimedia Analysis for Composed Image Retrieval](https://arxiv.org/abs/2602.13402)
...
### [3] [Revisiting Worker-Centered Design: Tensions, Blind Spots, and Action Spaces](https://arxiv.org/abs/2602.13424)
...
### [4] [Uncertain Pointer: Situated Feedforward Visualizations for Ambiguity-Aware AR Target Selection](https://arxiv.org/abs/2602.13433)
...
### [5] [How Multimodal Large Language Models Support Access to Visual Information: A Diary Study With Blind and Low Vision People](https://arxiv.org/abs/2602.13469)
...
### [6] [What Do We Mean by 'Pilot Study': Early Findings from a Meta-Review of Pilot Study Reporting at CHI](https://arxiv.org/abs/2602.13488)
...
### [7] [Designing Health Technologies for Immigrant Communities: Exploring Healthcare Providers' Communication Strategies with Patients](https://arxiv.org/abs/2602.13598)
...
### [8] [The Shadow Boss: Identifying Atomized Manipulations in Agentic Employment of XR Users using Scenario Constructions](https://arxiv.org/abs/2602.13622)
*Lik-Hang Lee*
...
### [9] [Anthropomorphism on Risk Perception: The Role of Trust and Domain Knowledge in Decision-Support AI](https://arxiv.org/abs/2602.13625)
...
### [10] [Search in Transition: A Study of University Students Perspectives on Using LLMs and Traditional Search Engines in English Test Problem Solving for Higher Study](https://arxiv.org/abs/2602.13629)
...
### [11] [Transferable XAI: Relating Understanding Across Domains with Explanation Transfer](https://arxiv.org/abs/2602.13675)
...
### [12] [Human Oversight-by-Design for Accessible Generative IUIs](https://arxiv.org/abs/2602.13745)
...
### [13] [Comparables XAI: Faithful Example-based AI Explanations with Counterfactual Trace Adjustments](https://arxiv.org/abs/2602.13784)
...
### [14] [What happens when reviewers receive AI feedback in their reviews?](https://arxiv.org/abs/2602.13817)
...
### [15] [Not Seeing the Whole Picture: Challenges and Opportunities in Using AI for Co-Making Physical DIY-AT for People with Visual Impairments](https://arxiv.org/abs/2602.13874)
...
### [16] [Avoiding Social Judgment, Seeking Privacy: Investigating why Mothers Shift from Facebook Groups to Large Language Models](https://arxiv.org/abs/2602.13941)
...
### [17] [A System of Care, Not Control: Co-Designing Online Safety and Wellbeing Solutions with Guardians ad Litem for Youth in Child Welfare](https://arxiv.org/abs/2602.13989)
...
### [18] [Customer Service Operations: A Gatekeeper Framework](https://arxiv.org/abs/2602.13998)
...
### [19] [Audience in the Loop: Viewer Feedback-Driven Content Creation in Micro-drama Production on Social Media](https://arxiv.org/abs/2602.14045)
...
### [20] [DALL: Data Labeling via Data Programming and Active Learning Enhanced by Large Language Models](https://arxiv.org/abs/2602.14102)
...
### [21] [Exploring a Multimodal Chatbot as a Facilitator in Therapeutic Art Activity](https://arxiv.org/abs/2602.14183)
...
### [22] [Designing a Rashomon Machine: Pluri-perspectivism and XAI for Creativity Support](https://arxiv.org/abs/2602.14232)
...
### [23] [Playing the Imitation Game: How Perceived Generated Content Shapes Player Experience](https://arxiv.org/abs/2602.14254)
...
### [24] [Key Considerations for Domain Expert Involvement in LLM Design and Evaluation: An Ethnographic Study](https://arxiv.org/abs/2602.14357)
...
### [25] ["I Felt Bad After We Ignored Her": Understanding How Interface-Driven Social Prominence Shapes Group Discussions with GenAI](https://arxiv.org/abs/2602.14407)
...
### [26] ['I Spend All My Energy Preparing': Balancing AI Automation and Agency for Self-Regulated Learning in SmartFlash](https://arxiv.org/abs/2602.14431)
...
### [27] [Touching Movement: 3D Tactile Poses for Supporting Blind People in Learning Body Movements](https://arxiv.org/abs/2602.14442)
...
### [28] [Conversational Decision Support for Information Search Under Uncertainty: Effects of Gist and Verbatim Feedback](https://arxiv.org/abs/2602.14467)
...
### [29] [When OpenClaw AI Agents Teach Each Other: Peer Learning Patterns in the Moltbook Community](https://arxiv.org/abs/2602.14477)
...
### [30] [Patient-Made Knowledge Networks: Long COVID Discourse, Epistemic Injustice, and Online Community Formation](https://arxiv.org/abs/2602.14528)
*Tawfiq Ammari*
...
### [31] [More than Decision Support: Exploring Patients' Longitudinal Usage of Large Language Models in Real-World Healthcare-Seeking Journeys](https://arxiv.org/abs/2602.14733)
...
### [32] [Robot-Wearable Conversation Hand-off for Navigation](https://arxiv.org/abs/2602.14831)
...
### [33] [TouchFusion: Multimodal Wristband Sensing for Ubiquitous Touch Interactions](https://arxiv.org/abs/2602.15011)
...
### [34] [Robustness Verification of Binary Neural Networks: An Ising and Quantum-Inspired Framework](https://arxiv.org/abs/2602.13536)
...
### [35] [From Snapshot Sensing to Persistent EM World Modeling: A Generative-Space Perspective for ISAC](https://arxiv.org/abs/2602.13554)
...
### [36] [Probabilistic approximate optimization using single-photon avalanche diode arrays](https://arxiv.org/abs/2602.13943)
...
### [37] [Introduction to Digital Twins for the Smart Grid](https://arxiv.org/abs/2602.14256)
...
### [38] [Agent Mars: Multi-Agent Simulation for Multi-Planetary Life Exploration and Settlement](https://arxiv.org/abs/2602.13291)
*Ziyang Wang*
...
### [39] [Adaptive Value Decomposition: Coordinating a Varying Number of Agents in Urban Systems](https://arxiv.org/abs/2602.13309)
...
### [40] [PeroMAS: A Multi-agent System of Perovskite Material Discovery](https://arxiv.org/abs/2602.13312)
...
### [41] [Robust Mean-Field Games with Risk Aversion and Bounded Rationality](https://arxiv.org/abs/2602.13353)
...
### [42] [G2CP: A Graph-Grounded Communication Protocol for Verifiable and Efficient Multi-Agent Reasoning](https://arxiv.org/abs/2602.13370)
...
### [43] [MAS-on-the-Fly: Dynamic Adaptation of LLM-based Multi-Agent Systems at Test Time](https://arxiv.org/abs/2602.13671)
...
### [44] [Testing BDI-based Multi-Agent Systems using Discrete Event Simulation](https://arxiv.org/abs/2602.13878)
...
### [45] [Socially-Weighted Alignment: A Game-Theoretic Framework for Multi-Agent LLM Systems](https://arxiv.org/abs/2602.14471)
...
### [46] [Towards Selection as Power: Bounding Decision Authority in Autonomous Agents](https://arxiv.org/abs/2602.14606)
...
### [47] [ST-EVO: Towards Generative Spatio-Temporal Evolution of Multi-Agent Communication Topologies](https://arxiv.org/abs/2602.14681)
...
### [48] [ROSA: Roundabout Optimized Speed Advisory with Multi-Agent Trajectory Prediction in Multimodal Traffic](https://arxiv.org/abs/2602.14780)
...
### [49] [Distributed Quantum Gaussian Processes for Multi-Agent Systems](https://arxiv.org/abs/2602.15006)
