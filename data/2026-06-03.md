...
### [1] [LLM-Assisted Reranking to Operationalize Nuanced Objectives in Recommender Systems](https://arxiv.org/abs/2606.02883)
...
### [4] [From 'What' to 'How' and 'Why': Sharing LLM-Generated Retrospective Summaries of Older Adults' Passive Tracking Data with Remote Family Members](https://arxiv.org/abs/2606.03876)
...
### [5] [AI Assistance for Discretionary Work: Increasing Feedback Provision in Higher Education](https://arxiv.org/abs/2606.03095)
...
### [7] [The Comparative Trap: How Social Comparison Orientation Drives Problematic Generative AI (GenAI) Use](https://arxiv.org/abs/2606.03560)
...
### [8] [Warning About AI Fallibility Increases Help-Seeking in an Intelligent Tutoring System](https://arxiv.org/abs/2606.03822)
...
### [9] [CLI-Anything: Towards Agent-Native Computer Use](https://arxiv.org/abs/2606.03854)
...
### [10] [DiffUNet^2: Bidirectional Prediction, Probabilistic Generation and Collaborative Visual Discovery for Scientific Data](https://arxiv.org/abs/2606.03926)
...
### [11] [Inference-Time Scaling for Joint Audio-Video Generation](https://arxiv.org/abs/2606.03183)
...
### [12] [OmniHalluc-L: Counterfactual Benchmarking and Modality-Perturbation Reliability Calibration for Long-Form Omni Hallucination](https://arxiv.org/abs/2606.03614)
...
### [13] [Fewer, Better Frames: A Compute-Normalized Proof of Concept for Coherence-First World-Model Rendering with Model-Guided FSR4 Frame Generation](https://arxiv.org/abs/2606.02586)
*Paweł Katarzyński*
...
### [14] [A Novel Procedural Generation for Level Design of Mansions and Dungeons](https://arxiv.org/abs/2606.03857)
...
### [15] [Glass Box at Orbit: A Constitutional AI Verification Framework for Trustworthy Autonomous CubeSat Intelligence](https://arxiv.org/abs/2606.02967)
...
### [16] [SA-DTS: Semantic-Aware Digital Twin Synchronization over 6G Networks](https://arxiv.org/abs/2606.03617)
*Vincenzo Sammartino*
...
### [17] [The Epi-LLM Framework: probing LLM behavioral priors through epidemiological agent-based models](https://arxiv.org/abs/2606.02867)
...
### [18] [Capability Advertisement as a Market for Lemons: A Trust Layer for Heterogeneous Agent Networks](https://arxiv.org/abs/2606.03034)
...
### [19] [OpenAgenet/OAN: Open Infrastructure for Trusted Agent Interconnection](https://arxiv.org/abs/2606.03161)
*Jinliang Xu*
...
### [20] [OpenAgenet/OAN: Technical Architecture for Trust-Governed Agent Identity and Discovery](https://arxiv.org/abs/2606.03163)
*Jinliang Xu*
...
### [21] [MeDxAgent: Multi-Agent Consultation for Interactive Medical Diagnosis](https://arxiv.org/abs/2606.03416)
...
### [22] [D2MDT: Department-aware Multidisciplinary Team Consultation with Deliberation for Efficient Clinical Prediction](https://arxiv.org/abs/2606.03543)
