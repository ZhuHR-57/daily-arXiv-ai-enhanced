...
### [5] [Fractional-order hardware for neuromorphic computing: Is the order really the problem?](https://arxiv.org/abs/2609.10882)
*Christof Teuscher*
...
### [6] [From Grid to Chip: Power Architecture, Stability, and Flexibility of AI Data Centers](https://arxiv.org/abs/2609.11649)
...
### [7] [A Time-Based Readout for Vector-Matrix Multiplication in Fully Analog Memristive SNNs](https://arxiv.org/abs/2609.11713)
...
### [8] [Tapes Together Strong: The Co-evolution of Computation and Cooperation](https://arxiv.org/abs/2609.10817)
...
### [9] [Evaluating Scaffolding-Oriented Multi-Agent Large Language Model System for Clinical Interview Training](https://arxiv.org/abs/2609.10939)
...
### [10] [But How Would AI Agents Run a Town's Economy?](https://arxiv.org/abs/2609.11108)
...
### [11] [ORCH: Organizational Principles Enable Collective Intelligence in Embodied AI](https://arxiv.org/abs/2609.11737)
...
### [12] [What Makes Creation Human? Authorship, Reasons, and Meaningful Human Control in Generative AI](https://arxiv.org/abs/2609.10738)
*Yuxi Cao*
...
### [13] ["Coder first, advocate second, college student third": The Liminality of Going to College as a Blind Computing Student](https://arxiv.org/abs/2609.10942)
...
### [14] [ShellVis: Sandboxed Live Programming for Shell Scripts](https://arxiv.org/abs/2609.11000)
...
### [15] [X-Hinges: 3D Printing Self-Sensing Compliant Mechanisms for Continuous and Multi-DOF Motion Sensing](https://arxiv.org/abs/2609.11077)
...
### [16] [Visual-Motion-Induced Modulation of Pedestrian Trajectories Using Spatially Distributed Multi-Display Signage in Public Spaces](https://arxiv.org/abs/2609.11088)
...
### [17] [How AI Coders Discuss, Disagree, and Reach Consensus: Challenges and Opportunities for LLM-Based Qualitative Coding](https://arxiv.org/abs/2609.11109)
...
### [18] [Conceptualising an Initial Design Space for Guidance in Digital Physical Activity Support](https://arxiv.org/abs/2609.11193)
...
### [19] [AI Soccer Analyst: Stage-Aware and Verifiable Human-AI Collaboration for Soccer Data Analysis](https://arxiv.org/abs/2609.11224)
...
### [20] [Are Caption Metrics Broken? Latency, Deaf and Hard of Hearing User Ratings, and Bias across Technologies](https://arxiv.org/abs/2609.11408)
...
### [21] [Design Reflections on Transition to LLM-Aided Novel Visualizations](https://arxiv.org/abs/2609.11503)
*Richard Brath*
...
### [22] [Ethics Training Agents: Facilitating Group-Based Ethics Education with Role-Playing and Discussion for Ethical Reflection and Exploration](https://arxiv.org/abs/2609.11529)
...
### [23] [Bigger than the EAR BOX: A Theory-Grounded Review of XR Accessibility Research for Deaf and Hard of Hearing Communities](https://arxiv.org/abs/2609.11706)
...
### [24] [Understanding Operator Attitudes Toward AI-Supported Decision Making in Maritime Operations](https://arxiv.org/abs/2609.11805)
...
### [25] [MotionQ: Operator-Conditioned Motion Quotients for Cross-Observation WiFi Gesture Recognition](https://arxiv.org/abs/2609.11818)
...
### [26] [Multi-Faceted Evaluation and Mitigation of Emotion Hallucinations in MLLMs](https://arxiv.org/abs/2609.11154)
...
### [27] [Multimodal Temporal Modeling for Continuous Group Emotion Recognition in Multi-party Dialogues](https://arxiv.org/abs/2609.11164)
