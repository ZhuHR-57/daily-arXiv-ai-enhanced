...
### [1] ["The Intangible Victory", Interactive Audiovisual Installation](https://arxiv.org/abs/2602.15071)
...
### [2] [Proactive Conversational Assistant for a Procedural Manual Task based on Audio and IMU](https://arxiv.org/abs/2602.15707)
...
### [3] [Multi-Agent Home Energy Management Assistant](https://arxiv.org/abs/2602.15219)
*Wooyoung Jung*
...
### [4] [Ground-Truth Depth in Vision Language Models: Spatial Context Understanding in Conversational AI for XR-Robotic Support in Emergency First Response](https://arxiv.org/abs/2602.15237)
...
### [5] [MyoInteract: A Framework for Fast Prototyping of Biomechanical HCI Tasks using Reinforcement Learning](https://arxiv.org/abs/2602.15245)
...
### [6] [From Diagnosis to Inoculation: Building Cognitive Resistance to AI Disempowerment](https://arxiv.org/abs/2602.15265)
*Aleksey Komissarov*
...
### [7] [Supporting Multimodal Data Interaction on Refreshable Tactile Displays: An Architecture to Combine Touch and Conversational AI](https://arxiv.org/abs/2602.15280)
...
### [8] [StatCounter: A Longitudinal Study of a Portable Scholarly Metric Display](https://arxiv.org/abs/2602.15413)
*Jonas Oppenlaender*
...
### [9] [Reflecting on 1,000 Social Media Journeys: Generational Patterns in Platform Transition](https://arxiv.org/abs/2602.15489)
...
### [10] ["What Are You Doing?": Effects of Intermediate Feedback from Agentic LLM In-Car Assistants During Multi-Step Processing](https://arxiv.org/abs/2602.15569)
...
### [11] [Meflex: A Multi-agent Scaffolding System for Entrepreneurial Ideation Iteration via Nonlinear Business Plan Writing](https://arxiv.org/abs/2602.15631)
...
### [12] [How to Disclose? Strategic AI Disclosure in Crowdfunding](https://arxiv.org/abs/2602.15698)
...
### [13] [Beyond Labels: Information-Efficient Human-in-the-Loop Learning using Ranking and Selection Queries](https://arxiv.org/abs/2602.15738)
...
### [14] [Unraveling Entangled Feeds: Rethinking Social Media Design to Enhance User Well-being](https://arxiv.org/abs/2602.15745)
...
### [15] [Pairwise XOR and XNOR Gates in Squeezed Instantaneous Noise Based Logic](https://arxiv.org/abs/2602.15032)
...
### [16] [High Convergence Rates of CMOS Invertible Logic Circuits Based on Many-Body Hamiltonians](https://arxiv.org/abs/2602.15033)
...
### [17] [Full-Field Damage Monitoring in Architected Lattices Using In situ Electrical Impedance Tomography](https://arxiv.org/abs/2602.15048)
...
### [18] [Quantum Optimization for Access Point Selection Under Budget Constraint](https://arxiv.org/abs/2602.15049)
...
### [19] [Quantum Computing for Healthcare Digital Twin Systems](https://arxiv.org/abs/2602.15477)
...
### [20] [Beyond Context Sharing: A Unified Agent Communication Protocol (ACP) for Secure, Federated, and Autonomous Agent-to-Agent (A2A) Orchestration](https://arxiv.org/abs/2602.15055)
...
### [21] [Colosseum: Auditing Collusion in Cooperative Multi-Agent Systems](https://arxiv.org/abs/2602.15198)
...
### [22] [Enhancing Computational Efficiency in NetLogo: Best Practices for Running Large-Scale Agent-Based Models on AWS and Cloud Infrastructures](https://arxiv.org/abs/2602.15317)
