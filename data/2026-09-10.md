...
### [1] [OmniEye: Efficient Multimodal Forensic Video Intelligence for Law-Enforcement Body-Worn Cameras](https://arxiv.org/abs/2609.09460)
...
### [2] [MotionCanvas: Learning Implicit Motion Planning from Composable Kinematic Cues](https://arxiv.org/abs/2609.10457)
...
### [3] [InstantMimic: A High Performance System for Learning Physics-based Skills in Seconds](https://arxiv.org/abs/2609.09821)
...
### [4] [RealSimLoop: Online Real-to-Sim Adaptation via Differentiable Reduced-Order Simulation with Vision Feedback](https://arxiv.org/abs/2609.09828)
...
### [5] [Semi-Implicit Pairwise Descent for Nonlocal Continuum Mechanics](https://arxiv.org/abs/2609.09834)
...
### [6] [Ephemeral Feeds and Enduring Rituals: RushTok and the Formation of Event-Based Algorithmic Communities](https://arxiv.org/abs/2609.09331)
...
### [7] [AppetiteCheck: Feasibility of Momentary Vagus Nerve Stimulation as an Implicit Intervention for Eating Behavior](https://arxiv.org/abs/2609.09700)
...
### [8] [Early Epistemic Settlement in AI-Assisted Writing](https://arxiv.org/abs/2609.09332)
*Han-yu Wang*
...
### [9] [Where Does the Human End? Creative Agency with Generative AI across Five Years of Chinese Digital Painting](https://arxiv.org/abs/2609.09333)
...
### [10] [MOONWALK: Mediating Operations with Intent-Evidence-Action Alignment Across Junior-Supervisor Review Workflows in Animation/VFX Pre-Production](https://arxiv.org/abs/2609.10385)
...
### [11] [Echoes in the Algorithm: Analyzing the Fidelity of User Preferences Against Realized Platform Reach](https://arxiv.org/abs/2609.09365)
*Emelia Hughes,Tim Weninger*
...
### [12] [Agentic Web Accessibility Auditing: Authoring and Evaluating Per-Criterion Worker Agents for WCAG](https://arxiv.org/abs/2609.09379)
...
### [13] ["It's Like Drinking from a Fire Hose": Understanding and Characterizing Video Learning Experiences for Individuals with ADHD](https://arxiv.org/abs/2609.09443)
...
### [14] [Exploring 3D Glyph Physicalizations for Public Engagement through River Health](https://arxiv.org/abs/2609.09472)
...
### [15] [Integrating Multi-Source Feedback in Computational Design](https://arxiv.org/abs/2609.09483)
...
### [16] [How Far Do Capability Cues Travel? Anthropomorphism and Differentiated Trust in a Platform-Embedded AI Assistant](https://arxiv.org/abs/2609.09713)
...
### [17] [Pairit: A Platform for Live Experiments on Human-AI Collaboration](https://arxiv.org/abs/2609.09789)
...
### [18] [Somatosensory Activation and Attentional States in Creative Making](https://arxiv.org/abs/2609.09960)
*Katherine Rees*
...
### [19] [Streaming P300 Acquisition and Statistical Signal Validation Across Five EEG Platforms: A Hardware-Agnostic BrainFlow/LSL Pipeline](https://arxiv.org/abs/2609.10047)
...
### [20] [Seeing the Voice, Preserving the Self: A Participatory Design Approach to Deaf-Centric Text-to-Speech](https://arxiv.org/abs/2609.10199)
