...
### [9] [ECHO: Dyadic 3D Facial Motion Generation with Asymmetric Deterministic Articulation and Stochastic Reaction](https://arxiv.org/abs/2609.05506)
...
### [10] [RBF Your SDF: Radial Basis Function Interpolation of Signed Distance Fields with Implied Tangent Points](https://arxiv.org/abs/2609.06209)
...
### [11] [Skinned Motion Retargeting via Artifact-driven Kinematic Prior Refinement](https://arxiv.org/abs/2609.06517)
...
### [12] [CT2Yarn: Yarn-Level Reconstruction of Crochet from Computed Tomography](https://arxiv.org/abs/2609.06950)
...
### [13] [Neural Centroidal Voronoi Tessellations](https://arxiv.org/abs/2609.08497)
...
### [14] [Inverse Digital Marbling: Recovering Gesture Programs with a Replay Adjoint](https://arxiv.org/abs/2609.08722)
...
### [15] [Seeing Without Understanding: Large Language Model Evaluation of Mobile User Interface Quality, Failure Taxonomy, and Architectural Explanation](https://arxiv.org/abs/2609.05423)
...
### [16] [Companion AI and Ethical Design: Learning from System Failures and User Desires](https://arxiv.org/abs/2609.05432)
...
### [17] [From Sensor Data to Classroom Inquiry: GenAI-Supported Exploration of School Digital Twin Data](https://arxiv.org/abs/2609.05452)
...
### [18] [An Agent Model Abstraction for Human-AI Teaming Cognitive Coupling](https://arxiv.org/abs/2609.05552)
...
### [19] [Will My Assistant Remember My Allergy? What Personal LLM Assistants Forget When Conversation Memory Is Compressed](https://arxiv.org/abs/2609.05767)
...
### [20] [Tactile Search: Enhancing Targeting in 3D Space](https://arxiv.org/abs/2609.05867)
...
### [21] [Art2Song: Enhancing Visual Art Appreciation with Contextual Music Generation](https://arxiv.org/abs/2609.06044)
...
### [22] [Designing for Healthy, Affordable, and Sustainable Human-HVAC Interactions for Heating in Smart Homes](https://arxiv.org/abs/2609.07936)
*Delong Korus-Du*
...
### [23] [Flawed but Memorable: Student Critical Reception of Interest-Personalized GenAI Analogies in Computing Education](https://arxiv.org/abs/2609.06095)
...
### [24] [MM-SVGEdit: A Multimodal-Driven SVG Editing for UI Design](https://arxiv.org/abs/2609.06116)
...
### [25] [Adaptive Ecological Momentary Assessment with a Hybrid Language Model: Formative Expert Review and Retrospective Evaluation](https://arxiv.org/abs/2609.06269)
...
### [26] [FrankenReport: Early Exiting in Long-Form Generation Using Expected Value of Computation](https://arxiv.org/abs/2609.06320)
...
### [27] [Can People Distinguish Human and AI Agency in Humanoid Teleoperation? A Preliminary Study of Agency Perception](https://arxiv.org/abs/2609.06434)
...
### [28] [Disclosure and dissolution: explainability, AI power, and situated agency in understanding](https://arxiv.org/abs/2609.06495)
*Dee Matthews*
...
### [29] [The Effectiveness of Virtual Patient Simulation Versus Peer Simulation in Providing Sexual Counseling During Pregnancy: A Randomized Controlled Trial](https://arxiv.org/abs/2609.06662)
...
### [30] [The Interface of Theseus: The Rise of Just-In-Time Interfaces](https://arxiv.org/abs/2609.06770)
*Michael S. Bernstein*
...
### [31] [Adaptive Complementarity in Human-AI Systems: Architecture as a State-Shaping Choice](https://arxiv.org/abs/2609.07001)
*Babak Heydari*
...
### [32] [Living with AI Companions: Sustained AI Companionship Predicts Lower Well-Being Through Lower Human Interaction](https://arxiv.org/abs/2609.07243)
...
### [33] [From Human Factors to Human-Technology Factors: An HCI Perspective on Technology in Avalanche Safety](https://arxiv.org/abs/2609.07560)
...
### [34] [Large-Scale User Behavior Analysis in Multimodal AI-Assisted Manual Task Execution](https://arxiv.org/abs/2609.07594)
...
### [35] [JudgmentLens: Human-AI Sensemaking of Complex Legal Judgments](https://arxiv.org/abs/2609.07607)
...
### [36] [Situated Action in Pre-Hospital Critical Care Dispatch: Identifying where and how Algorithmic Assistance might be useful in the daily work of specialist Emergency Medical Dispatchers](https://arxiv.org/abs/2609.07705)
...
### [37] [Quantifying the Engagement Trap: Impact of Short-form Video Recommender Systems on Users with ADHD](https://arxiv.org/abs/2609.07795)
...
### [38] [Humans Introduce, Models Elaborate: Asymmetric Narrative Agency in Human-LLM Co-Writing](https://arxiv.org/abs/2609.07920)
...
### [39] [Delusions and Harms Associated with AI Chatbot Use: Early Evidence from 185 Real-World Reports](https://arxiv.org/abs/2609.08027)
...
### [40] [Representational Fidelity in Didactic Visualization: Toward a Multidimensional Design Space](https://arxiv.org/abs/2609.08037)
...
### [41] [StitchOver: Technical Embroidery on Seamed Fabrics](https://arxiv.org/abs/2609.08311)
...
### [42] ["Here Be Sharks!": Enhancing Scientific Communication and Analysis through Authoring Interactivity](https://arxiv.org/abs/2609.08386)
...
### [43] [Enhancing Communication in Speech Therapy: Exploring the Cognitive Synergy Between Gesture and Speech](https://arxiv.org/abs/2609.08486)
...
### [44] [Visualizing Colonial Regimes: A Multi-View Approach to (Historical) Political Transformation](https://arxiv.org/abs/2609.08518)
...
### [45] [Rescuing Performance from the Demo: Co-Designing Drum Gesture Mappings with a Percussionist](https://arxiv.org/abs/2609.08587)
...
### [46] [Healthcare Utilization, Chronic Condition Management, and Workplace Functioning Among Users of a Purpose-Built Mental Health AI (Ash): Cross-Sectional Study](https://arxiv.org/abs/2609.08890)
...
### [47] [To Stop or Not to Stop: Exploring the Intention-Behavior Gaps in Smartphone Usage](https://arxiv.org/abs/2609.08909)
...
### [48] [Embedded Human-Centered Data Science in a Graduate Programming Course: A Framework and Case Study](https://arxiv.org/abs/2609.08982)
...
### [49] [Location-Independent Robot-Assisted Finishing Using Digital Twins and Extended Reality](https://arxiv.org/abs/2609.09061)
...
### [50] [Travel Package Booking Application with API Bot](https://arxiv.org/abs/2609.09112)
...
### [51] [CaseWeaver: A Multi-Agent Framework for Multimodal Virtual Clinical Case Generation](https://arxiv.org/abs/2609.05480)
...
### [52] [DART: A DAG-Based Reputation and Incentive Framework via Blockchain-Enabled Governance for Trustworthy LLM Multi-Agent Collaboration](https://arxiv.org/abs/2609.05529)
...
### [53] [SimTIO: A Simulation-Grounded Multi-Agent LLM Framework for Compositional Traffic Intervention Optimization](https://arxiv.org/abs/2609.05740)
...
### [54] [Adaptive stabilization of a leaderless bearing-constrained formation with disturbances](https://arxiv.org/abs/2609.06355)
...
### [55] [CAPMAS: Capability-Based Delegation of Privileges in Multi-Agent Systems](https://arxiv.org/abs/2609.06500)
...
### [56] [Certifying cooperation: a novel approach to cooperative multi-agent task generation](https://arxiv.org/abs/2609.06586)
...
### [57] [Audit Without Verification: When LLM Accountability Layers Relay Rather Than Check](https://arxiv.org/abs/2609.07680)
*Paul-Peter Arslan*
...
### [58] [Scaling Multi-Agent Systems with Prospect-State Propagation](https://arxiv.org/abs/2609.08033)
...
### [59] [Rank Without an Oracle: Deviation-Aware Interaction-Rank Selection from Offline Multi-Agent Logs](https://arxiv.org/abs/2609.08358)
...
### [60] [Reachability-Certified Subteam Decomposition for Locally Interacting Multi-Agent MDPs](https://arxiv.org/abs/2609.08366)
*Xiangwu Wang,Chengwei Cao,Hongyuan Tang*
...
### [61] [Beyond Agent Harnesses: Cross-Substrate Authority for Multi-Agent Systems](https://arxiv.org/abs/2609.08472)
...
### [62] [MorphoOrgaAgent: A Foundation-Model-Based Multi-Agent System for Autonomous Organoid Analysis](https://arxiv.org/abs/2609.08696)
...
### [63] [Copying explains the collective behavior of AI agents in the wild](https://arxiv.org/abs/2609.09150)
...
### [64] [MVWeaver: A Hierarchical Music Video Generation Agent with a Learned Song-to-Visual Bridge](https://arxiv.org/abs/2609.06478)
...
### [65] [Vision-Guided Text Prompt Tuning for Multimodal Sentiment Analysis](https://arxiv.org/abs/2609.06497)
...
### [66] [AdoDAS: A Privacy-Preserving Multimodal Challenge for Adolescent Depression, Anxiety, and Stress Assessment](https://arxiv.org/abs/2609.07038)
...
### [67] [Can Agents Win the Video Browser Showdown?](https://arxiv.org/abs/2609.07311)
...
### [68] [Concept-Level Risk and Calibration for Governance in Diffusion Foundation Models](https://arxiv.org/abs/2609.08517)
