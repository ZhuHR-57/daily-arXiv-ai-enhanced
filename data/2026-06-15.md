...
### [1] [HoloPathTracer: Fast and Accurate Wave Path Tracing for Holography](https://arxiv.org/abs/2606.14173)
...
### [2] [The Frustrometer: Detecting User Frustration in Data Visualization Tasks using Biomarkers and Interaction Patterns](https://arxiv.org/abs/2606.13687)
...
### [3] [Rethinking the UI of GenUI: A Tale of Two Designs](https://arxiv.org/abs/2606.13843)
...
### [4] [SpheriCity: Designing Trustworthy Conversational AI for Sustainability Decision Support](https://arxiv.org/abs/2606.13854)
...
### [5] [The Silent Cost of Artificial Intelligence Assistance: A Theory of Autonomy Surrender, the Recovery Mechanism, and the Restoration of Human Agency](https://arxiv.org/abs/2606.13962)
...
### [6] [Visible Adoption, Untracked Contribution: GitHub Evidence of the Accountability Gap Across Three Cohorts of an HCI Prototyping Course](https://arxiv.org/abs/2606.14054)
...
### [7] [Thinking Outside the [Chat]Box: Bridging Computer Science and Industrial Design for Cognitive-Inclusive Generative AI](https://arxiv.org/abs/2606.14306)
...
### [8] [Friction in AI-Assisted Clinical Decision-Making: A Case Study on The Role of Questions and 'What-if' Scenarios](https://arxiv.org/abs/2606.14406)
...
### [9] [Fabula: Building a Narrative Storytelling Sidekick with the Writers' Community](https://arxiv.org/abs/2606.14411)
...
### [10] [The Self-Aware Body: A User-Centered Framework for Designing Therapeutic Sonic Interactions](https://arxiv.org/abs/2606.14664)
