...
### [1] [Beyond Cash Flows: A Multi-Agent AI Framework for Valuing Clinical-Stage, Cross-Border Biotechnology](https://arxiv.org/abs/2608.10175)
*Yuhan Fang*
...
### [2] [The Deliberative Deficit: An Empirical Critique of LLMs in Democratic Discourse](https://arxiv.org/abs/2608.10186)
*Maurice Flechtner*
...
### [3] [Not a Monolith: Lab-Level Divergence in the Cooperative Equilibria of Chinese Frontier LLM Agents](https://arxiv.org/abs/2608.10262)
...
### [4] [ASCon: A Direction-Aware Reciprocal Agent--Step Contextualization Model for Failure Attribution in Multi-Agent Systems](https://arxiv.org/abs/2608.10646)
...
### [5] [Reifying Research Logic: AI-Assisted Workflow Construction and Incremental Refinement for Quantitative Syntax](https://arxiv.org/abs/2608.10662)
...
### [6] [Who Are You Explaining To? A Multi-Agent System for Audience-Aware XAI Narratives](https://arxiv.org/abs/2608.11033)
...
### [7] [Unsupervised Detection of Groundwater Storage Anomalies in Ghana Using GRACE Satellite Data](https://arxiv.org/abs/2608.10233)
...
### [8] [Amulet: Frame Extrapolation Through Sparse Layered Scene Representation and Adaptive Shading](https://arxiv.org/abs/2608.10423)
...
### [9] [WildFireGS: Physics-Based Wildfire Simulation in Large-Scale Semantics-Enriched Gaussian Splatting Forest Scenes](https://arxiv.org/abs/2608.11100)
...
### [10] [Visual-to-Haptic Augmentation in XR: A Wearable Glove for Perceptual Grounding in Multimodal Interaction](https://arxiv.org/abs/2608.10368)
...
### [11] [The impact of design factors of virtual and augmented reality on tertiary students user experience in Metaverse](https://arxiv.org/abs/2608.09940)
...
### [12] [How to Dogfood Your AI Chat Agent: A Three-Layer Evaluation Framework with Goal-Directed NPC Simulation](https://arxiv.org/abs/2608.09939)
...
### [13] [EweAcT: Ewe behaviour aligned to accelerometer data for activity monitoring in extensive grazing systems](https://arxiv.org/abs/2608.09943)
...
### [14] [Navigation Alone Is Not Enough: Evaluating Explanatory Assistive UI Agents](https://arxiv.org/abs/2608.09944)
*Santosh Patapati*
...
### [15] [Co-Lecturing With the DED: Explaining Circuit Design via the Draw Encode Display Loop](https://arxiv.org/abs/2608.09945)
...
### [16] [HoosierHelp: Benchmarking LLM Agents for Social Service Navigation](https://arxiv.org/abs/2608.09946)
...
### [17] [Mapping Multimodal Pilot Stress and Fatigue During Flight Sessions](https://arxiv.org/abs/2608.09947)
...
### [18] [Immersive Micromanipulation Integrating Pipette and Injector Operations with McKibben-Based Haptic Sensations for Workload Reduction](https://arxiv.org/abs/2608.10033)
...
### [19] [Outer Limits: An Experimental Approach to Controlled Content Manipulation within the Reddit Interface](https://arxiv.org/abs/2608.10115)
...
### [20] [Predicting affective connotation of visualizations from their constituent colors](https://arxiv.org/abs/2608.10169)
...
### [21] [Fine-Tuning Large Language Models for Codebook-Guided Coding of Students' Mathematics Metaphor Responses](https://arxiv.org/abs/2608.10276)
...
### [22] [Divided Attention Amplifies the Importance of Expectation-Aligned Visualization Design](https://arxiv.org/abs/2608.10320)
...
### [23] [Narrative Keyframing for Generative Creative Writing](https://arxiv.org/abs/2608.10337)
...
### [24] [ResonaVis: Visualizing Interactive Music Data to Support Reflective Music Composition for Therapeutic Contexts](https://arxiv.org/abs/2608.10338)
...
### [25] [MazzikaAI: A knowledge-based performance-to-prompt compiler for real-time Arabic maqam accompaniment with a streaming text-to-music model](https://arxiv.org/abs/2608.10360)
...
### [26] [Automatic Field-of-View Adjustment for a View-Expansive Microscope via LSTM-Based Gaze and Pipette Motion Interpretation](https://arxiv.org/abs/2608.10401)
...
### [27] [Elbow Angle Guidance System Based on Surface Haptic Sensations Elicited by Lightweight Wearable Fabric Actuator](https://arxiv.org/abs/2608.10404)
...
### [28] [When the Interviewer Is a Bot: Behavior, Breakdowns, and Trust in MLLM-Led Interviews](https://arxiv.org/abs/2608.10412)
...
### [29] [What We Know about Responsible AI Practices in Industry: A Half Decade of Empirical Research](https://arxiv.org/abs/2608.10431)
...
### [30] [Stay or Stray - A Dynamical Systems Viewpoint of Popularity Bias](https://arxiv.org/abs/2608.10474)
...
### [31] [ProtoGIB-Workload: Learning Workload-Specific Neural Topology Prototypes across Subjects](https://arxiv.org/abs/2608.10647)
...
### [32] [Longitudinal Evidence That General-Purpose Chatbots Actively Foster Relational Engagement](https://arxiv.org/abs/2608.10672)
...
### [33] [The Signal Rail: A Deterministic Motion Grammar for Communicating Conversational Agent State in Terminal Interfaces](https://arxiv.org/abs/2608.10689)
*Matteo Grella*
...
### [34] [Playable Pressure: Affective Dramaturgy and Selective Realism in the Design of a VR Emergency-Response Serious Game](https://arxiv.org/abs/2608.10763)
*Jan K. Argasiński*
...
### [35] [AI-Generated Interactive Fiction for Educational Use: A Pilot Study of Perceived Comprehensibility, Coherence, and Engagement](https://arxiv.org/abs/2608.10818)
