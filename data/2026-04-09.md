...
### [1] [Logical Robots: Declarative Multi-Agent Programming in Logica](https://arxiv.org/abs/2604.06629)
...
### [2] [Event-Triggered Adaptive Consensus for Multi-Robot Task Allocation](https://arxiv.org/abs/2604.06813)
...
### [3] [AgentCity: Constitutional Governance for Autonomous Agent Economies via Separation of Power](https://arxiv.org/abs/2604.07007)
...
### [4] [Strategic Persuasion with Trait-Conditioned Multi-Agent Systems for Iterative Legal Argumentation](https://arxiv.org/abs/2604.07028)
*Philipp D. Siedler*
...
### [5] [Designing for Accountable Agents: a Viewpoint](https://arxiv.org/abs/2604.07204)
...
### [6] [Intertemporal Demand Allocation for Inventory Control in Online Marketplaces](https://arxiv.org/abs/2604.07312)
...
### [7] [LungCURE: Benchmarking Multimodal Real-World Clinical Reasoning for Precision Lung Cancer Diagnosis and Treatment](https://arxiv.org/abs/2604.06925)
...
### [8] [GS-Surrogate: Deformable Gaussian Splatting for Parameter Space Exploration of Ensemble Simulations](https://arxiv.org/abs/2604.06358)
...
### [9] [Splats under Pressure: Exploring Performance-Energy Trade-offs in Real-Time 3D Gaussian Splatting under Constrained GPU Budgets](https://arxiv.org/abs/2604.07177)
...
### [10] [Language-Guided Multimodal Texture Authoring via Generative Models](https://arxiv.org/abs/2604.06489)
...
### [11] [BATON: A Multimodal Benchmark for Bidirectional Automation Transition Observation in Naturalistic Driving](https://arxiv.org/abs/2604.07263)
...
### [12] [X-BCD: Explainable Sensor-Based Behavioral Change Detection in Smart Home Environments](https://arxiv.org/abs/2604.06174)
...
### [13] [User-Centric Design of UI for Mobile Banking Apps: Improving UI and Features for Better Customer Experience](https://arxiv.org/abs/2604.06175)
...
### [14] ["Help Me, But Don't Watch Me": Intervention Timing and Privacy Boundaries for Process-Aware AI Tutors](https://arxiv.org/abs/2604.06178)
...
### [15] [Digital Weight Management Interventions: A review of commercial solutions and survey analysis of user needs](https://arxiv.org/abs/2604.06181)
...
### [16] [VenusBench-Mobile: A Challenging and User-Centric Benchmark for Mobile GUI Agents with Capability Diagnostics](https://arxiv.org/abs/2604.06182)
...
### [17] [The Impact of Response Latency and Task Type on Human-LLM Interaction and Perception](https://arxiv.org/abs/2604.06183)
...
### [18] [A Goal-Oriented Chatbot for Engaging the Elderly Through Family Photo Conversations](https://arxiv.org/abs/2604.06184)
...
### [19] [Benchmarking LLM Tool-Use in the Wild](https://arxiv.org/abs/2604.06185)
...
### [20] [Full State-Space Visualisation of the 8-Puzzle: Feasibility, Design, and Educational Use](https://arxiv.org/abs/2604.06186)
...
### [21] [Skin-Deep Bias: How Avatar Appearances Shape Perceptions of AI Hiring](https://arxiv.org/abs/2604.06187)
...
### [22] [LLM Spirals of Delusion: A Benchmarking Audit Study of AI Chatbot Interfaces](https://arxiv.org/abs/2604.06188)
...
### [23] [SASLO: A Scene-Aware Spatial Layout Optimization System for AR-SSVEP](https://arxiv.org/abs/2604.06190)
...
### [24] ["It didn't feel right but I needed a job so desperately": Understanding People's Emotions & Help Needs During Financial Scams](https://arxiv.org/abs/2604.06218)
...
### [25] [Navigating Marginalization: Toward Justice-Oriented Socio-Technical Design for Parent-Child Learning among Southeast Asian Immigrant Mothers in Taiwan](https://arxiv.org/abs/2604.06353)
...
### [26] [Intimacy as Service, Harm as Externality: Critical Perspectives on AI Companion Platform Accountability](https://arxiv.org/abs/2604.06381)
...
### [27] [Reproducibility Beyond Artifacts: Interactional Support for Collaborative Machine Learning](https://arxiv.org/abs/2604.06414)
...
### [28] [Trust in AI among Middle Eastern CS Students: Investigating Students' Trust and Usage Patterns Across Saudi Arabia, Kuwait and Jordan](https://arxiv.org/abs/2604.06418)
...
### [29] [Intimate Strangers by Design: A Uses and Gratifications Analysis of AI Companionship](https://arxiv.org/abs/2604.06419)
*Dayeon Eom,Julianne Renner,Sedona Chinn*
...
### [30] [Breaking Negative Cycles: A Reflection-To-Action System For Adaptive Change](https://arxiv.org/abs/2604.06477)
...
### [31] [Meaningful Human Command: Towards a New Model for Military Human-Robot Interaction](https://arxiv.org/abs/2604.06611)
...
### [32] [MemoryDiorama: Generating Dynamic 3D Diorama from Everyday Photos for Memory Recall](https://arxiv.org/abs/2604.06773)
...
### [33] [Physics-driven Sonification for Improving Multisensory Needle Guidance in Percutaneous Epicardial Access](https://arxiv.org/abs/2604.06911)
...
### [34] [BioMoTouch: Touch-Based Behavioral Authentication via Biometric-Motion Interaction Modeling](https://arxiv.org/abs/2604.07071)
...
### [35] [Workmanship of Learning: Embedding Craftsmanship Values in AI-Integrated Educational Tools](https://arxiv.org/abs/2604.07118)
...
### [36] [Mixed-Initiative Context: Structuring and Managing Context for Human-AI Collaboration](https://arxiv.org/abs/2604.07121)
...
### [37] [Critical Inker: Scaffolding Critical Thinking in AI-Assisted Writing Through Socratic Questioning](https://arxiv.org/abs/2604.07167)
...
### [38] [Reshaping Inclusive Interpersonal Dynamics through Smart Glasses in Mixed-Vision Social Activities](https://arxiv.org/abs/2604.07232)
...
### [39] [Mapping Child Malnutrition and Measuring Efficiency of Community Healthcare Workers through Location Based Games in India](https://arxiv.org/abs/2604.07299)
...
### [40] [NIRVANA: A Comprehensive Dataset for Reproducing How Students Use Generative AI for Essay Writing](https://arxiv.org/abs/2604.07344)
...
### [41] [Computing In Spintronic Memory: A Thermal Perspective](https://arxiv.org/abs/2604.06667)
...
### [42] [Improving Feasibility in Quantum Approximate Optimization Algorithm for Vehicle Routing via Constraint-Aware Initialization and Hybrid XY-X Mixing](https://arxiv.org/abs/2604.07218)
