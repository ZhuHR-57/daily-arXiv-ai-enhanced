...
### [1] [How Historians Use Visualization: A Corpus-Backed Taxonomy and Analysis for Cross-Disciplinary Practice](https://arxiv.org/abs/2605.01456)
...
### [2] [The Antipodal Method: Fast, Accurate, and Robust 3D Generalized Winding Numbers](https://arxiv.org/abs/2605.01536)
...
### [3] [Greed for the Spheres: A Signed Distance Interpolation Method](https://arxiv.org/abs/2605.01919)
...
### [4] [Generative Modeling with Orbit-Space Particle Flow Matching](https://arxiv.org/abs/2605.02222)
...
### [5] [Structural MAT: Clean and Scalable Medial Axis Simplification via Explicit Surface Correspondence](https://arxiv.org/abs/2605.02302)
...
### [6] [Adaptive Interpolation-Synthesis for Motion In-Betweening on Keyframe-Based Animation](https://arxiv.org/abs/2605.02742)
...
### [7] [Implicit Minimal Surfaces for Bijective Correspondences](https://arxiv.org/abs/2605.02770)
...
### [8] [Breaking the Communication-Accuracy Trade-off: A Sparsified Information Diffusion Framework for Multi-Agent Collaborative Perception](https://arxiv.org/abs/2605.00946)
...
### [9] [Separation Assurance between Heterogeneous Fleets of Small Unmanned Aerial Systems via Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2605.01041)
...
### [10] [rAIson: Developing Reliable Decision-Making Agents](https://arxiv.org/abs/2605.01351)
...
### [11] [Talk is Cheap, Communication is Hard: Dynamic Grounding Failures and Repair in Multi-Agent Negotiation](https://arxiv.org/abs/2605.01750)
...
### [12] [Koopman Representations for Early Outbreak Warning and Minimal Counterfactual Intervention in Multi-Agent Epidemic Simulations](https://arxiv.org/abs/2605.01803)
*Florin Leon*
...
### [13] [Coopetition-Gym v1: A Formally Grounded Platform for Mixed-Motive Multi-Agent Reinforcement Learning under Strategic Coopetition](https://arxiv.org/abs/2605.02063)
*Vik Pant,Eric Yu*
...
### [14] [SOTOPIA-TOM: Evaluating Information Management in Multi-Agent Interaction with Theory of Mind](https://arxiv.org/abs/2605.02307)
...
### [15] [LLM-enabled Social Agents](https://arxiv.org/abs/2605.02335)
...
### [16] [When Stress Becomes Signal: Detecting Antifragility-Compatible Regimes in Multi-Agent LLM Systems](https://arxiv.org/abs/2605.02463)
...
### [17] [Analytic Framework for Estimating Memory Cost](https://arxiv.org/abs/2605.01793)
...
### [18] [AnimationDiff: A Visual Comparison Tool for Generated 3D Character Animations](https://arxiv.org/abs/2605.01001)
...
### [19] [Temporal Out-of-Distribution Detection for Asynchronous Motor Imagery Brain-Computer Interfaces](https://arxiv.org/abs/2605.01014)
...
### [20] [Non-Markovian Dynamical Systems Modeling of Electroencephalogram-based Brain Activity for Anticipating the Cognitive Fatigue Level](https://arxiv.org/abs/2605.01043)
...
### [21] [What Makes an AI Writing Companion a Good Fit? A Personality-Informed Co-Design Study](https://arxiv.org/abs/2605.01108)
...
### [22] [Toward a Unified Framework for Collaborative Design of Human-AI Interaction](https://arxiv.org/abs/2605.01153)
...
### [23] [EduGage: Methods and Dataset for Sensor-Based Momentary Assessment of Engagement in Self-Guided Video Learning](https://arxiv.org/abs/2605.01238)
...
### [24] [The Garden of Forking Paths: Narrative Arc-Conditioned Gameplay Planning](https://arxiv.org/abs/2605.01245)
...
### [25] [What Does a Meow Mean? In Search of Intuitively Understandable Communication by a Nonverbal Companion Robot](https://arxiv.org/abs/2605.01251)
...
### [26] [Investigating the Effects of Different Levels of User Control in an Interactive Educational Recommender System](https://arxiv.org/abs/2605.01400)
...
### [27] [AI Expert Twin: Capturing Expert Cognition for Human-Centred, Practice-Based Learning](https://arxiv.org/abs/2605.01401)
...
### [28] [Less Interaction But More Explanation: A Communication Perspective on Agentic AI Interfaces](https://arxiv.org/abs/2605.01610)
...
### [29] [LLM-Augmented Semantic Steering of Text Embedding Projection Spaces](https://arxiv.org/abs/2605.01957)
...
### [30] [Privy: From Fine Print to Fair Practice in Privacy Rights Exercise](https://arxiv.org/abs/2605.02005)
...
### [31] [Cripping AI: Reimagining AI Through Lived Disability Experiences](https://arxiv.org/abs/2605.02080)
...
### [32] [From 'Here' to 'There': Exploring Proximity Semantics in Multimodal Data Exploration](https://arxiv.org/abs/2605.02261)
...
### [33] [Robotic Affection -- Opportunities of AI-based haptic interactions to improve social robotic touch through a multi-deep-learning approach](https://arxiv.org/abs/2605.02538)
...
### [34] [Evaluating Different Modalities of Behavioral Approach Tests for Spider Phobia in Virtual Reality](https://arxiv.org/abs/2605.02546)
...
### [35] [Dramaturgies of Deception: AI Humanizers and the Performance of Legitimacy in Higher Education Assessment](https://arxiv.org/abs/2605.02649)
...
### [36] [ProPACT: A Proactive AI-Driven Adaptive Collaborative Tutor for Pair Programming](https://arxiv.org/abs/2605.02703)
...
### [37] [Augmenting Interface Usability Heuristics for Reliable Computer-Use Agents](https://arxiv.org/abs/2605.02729)
...
### [38] [Exploring Instant Photography using Generative AI: A Design Probe with the UnReality Camera](https://arxiv.org/abs/2605.02805)
...
### [39] [TRACE: Temporal Reasoning over Context and Evidence for Activity Recognition in Smart Homes](https://arxiv.org/abs/2605.02841)
...
### [40] ["I Don't Have Faith in the Developers to Use My Feedback": Understanding Player Values and Expectancy for Reporting Systems in Video Games](https://arxiv.org/abs/2605.02842)
...
### [41] [BRITE: A Benchmark for Reliable and Interpretable T2V Evaluation on Implausible Scenarios](https://arxiv.org/abs/2605.00873)
...
### [42] [OceanPile: A Large-Scale Multimodal Ocean Corpus for Foundation Models](https://arxiv.org/abs/2605.00877)
...
### [43] [Multimodal Confidence Modeling in Audio-Visual Quality Assessment](https://arxiv.org/abs/2605.01219)
...
### [44] [Contextual Wireless Video Semantic Communication in MIMO-OFDM Systems](https://arxiv.org/abs/2605.01798)
...
### [45] [Period-conscious Time-series Reconstruction under Local Differential Privacy](https://arxiv.org/abs/2605.02724)
...
### [46] [The Streaming Reservoir Convergence Theorem: A Prospect-Theoretic Framework for Multi-Provider Adaptive Streaming](https://arxiv.org/abs/2605.02761)
