...
### [5] [Unpacking Interpretability: Human-Centered Criteria for Optimal Combinatorial Solutions](https://arxiv.org/abs/2603.08856)
...
### [6] [Touching Emotions, Smelling Shapes: Exploring Tactile, Olfactory and Emotional Cross-sensory Correspondences in Preschool Aged Children](https://arxiv.org/abs/2603.08889)
...
### [7] [A Decentralized Frontier AI Architecture Based on Personal Instances, Synthetic Data, and Collective Context Synchronization](https://arxiv.org/abs/2603.08893)
...
### [8] [From Perception to Cognition: How Latency Affects Interaction Fluency and Social Presence in VR Conferencing](https://arxiv.org/abs/2603.09261)
...
### [9] [Understanding the Use of a Large Language Model-Powered Guide to Make Virtual Reality Accessible for Blind and Low Vision People](https://arxiv.org/abs/2603.09964)
...
### [10] [Dynamic Multimodal Expression Generation for LLM-Driven Pedagogical Agents: From User Experience Perspective](https://arxiv.org/abs/2603.09536)
...
### [19] [Entangling Like Mycorrhizae: Mixing Realities Through Touch in "FungiSync"](https://arxiv.org/abs/2603.09272)
...
### [20] [Reading the Mood Behind Words: Integrating Prosody-Derived Emotional Context into Socially Responsive VR Agents](https://arxiv.org/abs/2603.09324)
...
### [21] [The Richest Paradigm You're Not Using: Commercial Videogames at the Intersection of Human-Computer Interaction and Cognitive Science](https://arxiv.org/abs/2603.09753)
...
### [22] [The Bureaucracy of Speed: Structural Equivalence Between Memory Consistency Models and Multi-Agent Authorization Revocation](https://arxiv.org/abs/2603.09875)
*Vladyslav Parakhin*
...
### [23] [Emotional Modulation in Swarm Decision Dynamics](https://arxiv.org/abs/2603.09963)
...
### [24] [TPIFM: A Task-Aware Model for Evaluating Perceptual Interaction Fluency in Remote AR Collaboration](https://arxiv.org/abs/2603.09264)
*Jiarun Song,Ninghao Wan,Fuzheng Yang,Weisi Lin*
...
### [25] [Latency Effects on Multi-Dimensional QoE in Networked VR Whiteboards](https://arxiv.org/abs/2603.09294)
...
### [26] [MORE-R1: Guiding LVLM for Multimodal Object-Entity Relation Extraction via Stepwise Reasoning with Reinforcement Learning](https://arxiv.org/abs/2603.09478)
...
### [27] [Prompt-Driven Color Accessibility Evaluation in Diffusion-based Image Generation Models](https://arxiv.org/abs/2603.09832)
...
### [28] [MM-tau-p$^2$: Persona-Adaptive Prompting for Robust Multi-Modal Agent Evaluation in Dual-Control Settings](https://arxiv.org/abs/2603.09643)
...
### [29] [WVA: A Global Optimization Control Plane for llmd](https://arxiv.org/abs/2603.09730)
...
### [30] [Trade-Offs in FMCW Radar-Based Respiration and Heart Rate Variability](https://arxiv.org/abs/2603.09791)
...
### [31] [Layered Dielectric Characterization of Human Skin in the Sub-Terahertz and Terahertz Frequency Ranges](https://arxiv.org/abs/2603.09822)
