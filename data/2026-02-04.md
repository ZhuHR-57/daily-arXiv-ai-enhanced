...
### [2] [ADx3: A Collaborative Workflow for High-Quality Accessible Audio Description](https://arxiv.org/abs/2602.02684)
...
### [3] [Framing Responsible Design of AI Mental Well-Being Support: AI as Primary Care, Nutritional Supplement, or Yoga Instructor?](https://arxiv.org/abs/2602.02740)
...
### [4] [Exploring Collaborative Immersive Visualization & Analytics for High-Dimensional Scientific Data through Domain Expert Perspectives](https://arxiv.org/abs/2602.02743)
...
### [5] [Ethical Asymmetry in Human-Robot Interaction - An Empirical Test of Sparrow's Hypothesis](https://arxiv.org/abs/2602.02745)
...
### [6] [From Speech-to-Spatial: Grounding Utterances on A Live Shared View with Augmented Reality](https://arxiv.org/abs/2602.03059)
...
### [7] [Smell with Genji: Rediscovering Human Perception through an Olfactory Game with AI](https://arxiv.org/abs/2602.02785)
...
### [8] [Simulating Human Audiovisual Search Behavior](https://arxiv.org/abs/2602.02790)
...
### [9] [Invisible Users in Digital Health: A Scoping Review of Digital Interventions to Promote Physical Activity Among Culturally and Linguistically Diverse Women](https://arxiv.org/abs/2602.02982)
...
### [10] [Towards Considerate Embodied AI: Co-Designing Situated Multi-Site Healthcare Robots from Abstract Concepts to High-Fidelity Prototypes](https://arxiv.org/abs/2602.03054)
...
### [11] [Occlusion-Free Conformal Lensing for Spatiotemporal Visualization in 3D Urban Analytics](https://arxiv.org/abs/2602.03743)
...
### [12] [Gen-Diaolou: An Integrated AI-Assisted Interactive System for Diachronic Understanding and Preservation of the Kaiping Diaolou](https://arxiv.org/abs/2602.03095)
...
### [13] ["I'm happy even though it's not real": GenAI Photo Editing as a Remembering Experience](https://arxiv.org/abs/2602.03104)
...
### [14] [Behind the Feed: A Taxonomy of User-Facing Cues for Algorithmic Transparency in Social Media](https://arxiv.org/abs/2602.03121)
*Haoze Guo,Ziqi Wei*
...
### [15] [Intelligent Front-End Personalization: AI-Driven UI Adaptation](https://arxiv.org/abs/2602.03154)
*Mona Rajhans*
...
### [16] [Is It Possible to Make Chatbots Virtuous? Investigating a Virtue-Based Design Methodology Applied to LLMs](https://arxiv.org/abs/2602.03155)
...
### [17] [Exploring the Role of Tracing in AI-Supported Planning for Algorithmic Reasoning](https://arxiv.org/abs/2602.03197)
...
### [18] [How do people watch AI-generated videos of physical scenes?](https://arxiv.org/abs/2602.03374)
...
### [19] [TactDeform: Finger Pad Deformation Inspired Spatial Tactile Feedback for Virtual Geometry Exploration](https://arxiv.org/abs/2602.03476)
...
### [20] [PrevizWhiz: Combining Rough 3D Scenes and 2D Video to Guide Generative Video Previsualization](https://arxiv.org/abs/2602.03838)
...
### [21] [VoroUDF: Meshing Unsigned Distance Fields with Voronoi Optimization](https://arxiv.org/abs/2602.02907)
...
### [22] [Role of Graphics in Disaster Communication: Practitioner Perspectives on Use, Challenges, and Inclusivity](https://arxiv.org/abs/2602.02947)
...
### [23] [WebSplatter: Enabling Cross-Device Efficient Gaussian Splatting in Web Browsers via WebGPU](https://arxiv.org/abs/2602.03207)
...
### [24] [Pi-GS: Sparse-View Gaussian Splatting with Dense π^3 Initialization](https://arxiv.org/abs/2602.03327)
...
### [25] [Split&Splat: Zero-Shot Panoptic Segmentation via Explicit Instance Modeling and 3D Gaussian Splatting](https://arxiv.org/abs/2602.03809)
...
### [26] [Exploring Silicon-Based Societies: An Early Study of the Moltbook Agent Community](https://arxiv.org/abs/2602.02613)
...
### [27] [Scaling Small Agents Through Strategy Auctions](https://arxiv.org/abs/2602.02751)
...
### [28] [Game-Theoretic and Algorithmic Analyses of Multi-Agent Routing under Crossing Costs](https://arxiv.org/abs/2602.03455)
...
### [29] [When Should Agents Coordinate in Differentiable Sequential Decision Problems?](https://arxiv.org/abs/2602.03674)
...
### [30] [Agent Primitives: Reusable Latent Building Blocks for Multi-Agent Systems](https://arxiv.org/abs/2602.03695)
