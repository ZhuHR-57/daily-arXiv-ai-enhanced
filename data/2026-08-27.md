...
### [2] [Simulating Cognitive Smart Freight Corridors with Agent-Based Models and Reinforcement Learning](https://arxiv.org/abs/2608.25193)
...
### [3] [GPU-Accelerated Quantum Annealing-Inspired UAV Path Planning for Smart Agriculture](https://arxiv.org/abs/2608.25376)
...
### [4] [Study of Resistive Switching Dynamics and Memory States Equilibria in Analog Filamentary Conductive-Metal-Oxide/HfOx ReRAM via Compact Modeling](https://arxiv.org/abs/2608.25767)
...
### [5] [Update Disturbance-Resilient Analog ReRAM Crossbar Arrays for In-Memory Deep Learning Accelerators](https://arxiv.org/abs/2608.25781)
...
### [6] [Simultaneous Digital Communication and Deformation Sensing over a Single Stretchable Interconnect](https://arxiv.org/abs/2608.25801)
...
### [7] [User-Centered Design for Digital Patient-Navigation Tools in Oncology: Scoping Review](https://arxiv.org/abs/2608.24887)
...
### [8] [Agentic World Analysis (AWA) - an alternative way to explore systems and support decision making](https://arxiv.org/abs/2608.24896)
...
### [9] [MCP-Driven Accessibility Tree Standardization for AI-Powered Screen Reader Agents](https://arxiv.org/abs/2608.24898)
...
### [10] [aipsy-judge: A Specialized, Psychologist-Corrected Local Judge for the Psychological Safety of Conversational AI](https://arxiv.org/abs/2608.24899)
...
### [11] [Stronger Alignment between Brain Activity and LLM Embeddings during Code Writing compared to Prose Writing](https://arxiv.org/abs/2608.24900)
...
### [12] [Beyond the Chatbot: Co-Learning and Co-Teaching through a Dual-Persona Generative-AI Assistant](https://arxiv.org/abs/2608.24902)
...
### [13] [Evidence-Grounded Mapping of Multimodal Human Sensing Psychological Transdiagnostic Dimensions](https://arxiv.org/abs/2608.24903)
...
### [14] [PARAssist: A Framework for Personalized and Adaptive Robotic Assistance from Ambiguous User Requests](https://arxiv.org/abs/2608.24905)
...
### [15] [PA-CoT: Profile-Adaptive Chain-of-Thought for Personalized Nutritional Consulting](https://arxiv.org/abs/2608.24907)
...
### [16] [Hallucination by proxy in LLM-assisted differential diagnosis](https://arxiv.org/abs/2608.24908)
...
### [17] [Super Star: Towards Streaming Real-time Interactive Agents for Digital Humans](https://arxiv.org/abs/2608.24909)
...
### [18] [From Plots to Words: Model-Aware Multimodal Explanations as a Foundation for Accessible, Non-Visual Interaction](https://arxiv.org/abs/2608.24910)
...
### [19] [Visualizing Patient Trajectories and Disorder Co-occurrences in Child and Adolescent Mental Health](https://arxiv.org/abs/2608.24911)
...
### [20] [Analyzing and Correcting Benevolence Bias in Large Language Models](https://arxiv.org/abs/2608.24912)
...
### [21] [From Blind Edits to Verified Repair: Building Trustworthy User-Side LLM Agents for Web Accessibility](https://arxiv.org/abs/2608.24913)
...
### [22] [AI-Ready Research Workflows in Computational Social Science: Lessons on Building a Shared Language for Interdisciplinary Collaboration](https://arxiv.org/abs/2608.24914)
...
### [23] [What Are We Measuring? Bonding, Trust, and the Evaluation of Human-Robot Relationships](https://arxiv.org/abs/2608.24915)
*Imran Khan*
...
### [24] [Teaching Geometric Proof with Tech: Pitfalls and Possibilities](https://arxiv.org/abs/2608.25117)
...
### [25] [The Systems Paper is Dead. Long Live the Systems Paper](https://arxiv.org/abs/2608.25219)
*Bjoern Hartmann*
...
### [26] ["Am I Just That Dumb?": Applicability, Action and Verification in Consumer IoT Security Advice](https://arxiv.org/abs/2608.25225)
...
### [27] [AVI-Personality: A Trait-Activated Multimodal Dataset for Personality and Competency Assessment in Asynchronous Video Interviews](https://arxiv.org/abs/2608.25316)
...
### [28] [HRGuard: Gating Relationship Manipulation in Multi-Turn Agentic AI Conversations](https://arxiv.org/abs/2608.25340)
...
### [29] [Q&A or Document-Based? The Effects of Interface Type on How Screen Reader Users Access Interconnected Documents](https://arxiv.org/abs/2608.25382)
...
### [30] [TailorCoPilot: Enabling Agentic Pattern Making with Version-Controlled State Tracking](https://arxiv.org/abs/2608.25462)
...
### [31] [ScentEcho: Exploring Adsorbent Materials for Accurate Odor Collection and Playback](https://arxiv.org/abs/2608.25494)
...
### [32] [The Well-Being Palette: An Action-Word Selection Tool Designed for Low-Burden Reflection on Workplace Well-Being](https://arxiv.org/abs/2608.25527)
...
### [33] [Maru: Information Architecture as a Shared Language for Generating Aligned and Persistent User Interfaces](https://arxiv.org/abs/2608.25565)
...
### [34] [Are Concept Bottleneck Models Effective as Decision-Support Systems?](https://arxiv.org/abs/2608.25581)
...
### [35] [AffectSim: A Controllable Interactive 3D Simulation Benchmark for Embodied Affective Perception](https://arxiv.org/abs/2608.25664)
...
### [36] [Large Language Model Few-Shot Prompting with Dilemma Training Outperforms Human Surrogates in Predicting Patient Preferences](https://arxiv.org/abs/2608.25771)
...
### [37] [Do Vision-Language Models Agree on the Affective Qualities of Shape? A Cross-Model Audit for Generative Design Interfaces](https://arxiv.org/abs/2608.25876)
...
### [38] [Gaming Together on Discord: Teen Gamer's Cross-Platform Practices](https://arxiv.org/abs/2608.25942)
...
### [39] [From Producing to Validating: How AI Is Deskilling Freelancers](https://arxiv.org/abs/2608.26089)
*Nakul Rajpal*
...
### [40] [Hamiltonian Two-Way Coupling of Nonlinear Waves and 3D Flows](https://arxiv.org/abs/2608.25203)
...
### [41] [GLOSS: Geometric Local Self-Similarity Learning for Faithful Reference-Guided Texture Fill](https://arxiv.org/abs/2608.25461)
...
### [42] [BVR Sim: An Open and High-Throughput Environment for Heterogeneous Air-Combat Reinforcement Learning](https://arxiv.org/abs/2608.25419)
...
### [43] [Trust-Aware Sequential Decision Making and Rollout Planning for Resilient Multi-Robot Systems](https://arxiv.org/abs/2608.25690)
...
### [44] [HypoForge: A Self-Improving Multi-Agent Framework for Automated Hypothesis Generation and Testing via Scientific Skill Learning](https://arxiv.org/abs/2608.25770)
...
### [45] [AI Agentic Selective Laser Sintering Process Optimization](https://arxiv.org/abs/2608.25928)
...
### [46] [Praxist: From Experimental Artifacts to Solution Lineages](https://arxiv.org/abs/2608.25955)
