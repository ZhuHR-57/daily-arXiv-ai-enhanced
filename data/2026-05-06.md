...
### [1] [ADS: Random Sampling of Occupancy Functions using Adaptive Delaunay Scaffolding](https://arxiv.org/abs/2605.03235)
...
### [2] [Precomputed Lens Transport Maps](https://arxiv.org/abs/2605.04017)
...
### [3] [Stage Light is Sequence$^2$: Multi-Light Control via Imitation Learning](https://arxiv.org/abs/2605.03660)
...
### [4] [Resource Allocation and AoI-Aware Detection for ISAC with Stacked Intelligent Metasurfaces](https://arxiv.org/abs/2605.03558)
...
### [5] [MARS-DA: A Hierarchical Reinforcement Learning Framework for Risk-Aware Multi-Agent Bidding in Power Grids](https://arxiv.org/abs/2605.03142)
...
### [6] [Enwar 3.0: An Agentic Multi-Modal LLM Orchestrator for Situation-Aware Beamforming, Blockage Prediction, and Handover Management](https://arxiv.org/abs/2605.03215)
...
### [7] [Coordination as an Architectural Layer for LLM-Based Multi-Agent Systems](https://arxiv.org/abs/2605.03310)
...
### [8] [MemFlow: Intent-Driven Memory Orchestration for Small Language Model Agents](https://arxiv.org/abs/2605.03312)
...
### [9] [Physics-Grounded Multi-Agent Architecture for Traceable, Risk-Aware Human-AI Decision Support in Manufacturing](https://arxiv.org/abs/2605.04003)
...
### [10] [Same Voice, Different Lab: On the Homogenization of Frontier LLM Personalities](https://arxiv.org/abs/2605.02897)
...
### [11] [What Shapes Participant Data Quality? A Scoping Review and Case Study of Crowdsourced Webcam Eye Tracking in AI Interviews](https://arxiv.org/abs/2605.02898)
...
### [12] [A Study of Consumers Cognitive Load in eCommerce Websites using Eye-tracking Technology](https://arxiv.org/abs/2605.02899)
...
### [13] [Towards an End-to-End System for 3D Tracking of Physical Objects in Virtual Immersive Environments](https://arxiv.org/abs/2605.02901)
...
### [19] [Attention: What Prevents Young Adults from Speaking Up Against Cyberbullying in an LLM-Powered Social Media Simulation](https://arxiv.org/abs/2605.03287)
...
### [20] [The Fragility of AI Companionship: Ontological, Structural, and Normative Uncertainty in Human-AI Relationships](https://arxiv.org/abs/2605.03367)
...
### [21] [Bodyless Presence: Reconsidering the Minimal Self in Immersive Video](https://arxiv.org/abs/2605.03873)
*Koichi Toida*
...
### [22] [Deco: Extending Personal Physical Objects into Pervasive AI Companion through a Dual-Embodiment Framework](https://arxiv.org/abs/2605.03882)
...
### [23] [Stayin' Aligned Over Time: Towards Longitudinal Human-LLM Alignment via Contextual Reflection and Privacy-Preserving Behavioral Data](https://arxiv.org/abs/2605.04029)
