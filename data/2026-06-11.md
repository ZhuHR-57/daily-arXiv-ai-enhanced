...
### [1] [XPR: An Extensible Cross-Platform Point-Based Differentiable Renderer](https://arxiv.org/abs/2606.11529)
...
### [2] [MoGeFlow: Flowing Through Motion Codebook Geometry for Text-to-Motion Generation](https://arxiv.org/abs/2606.11656)
...
### [3] [Towards a Joint Understanding of Remote Operation for Vehicles in Public Road Traffic](https://arxiv.org/abs/2606.11336)
...
### [4] [3-Key-Input: Exploring the Theoretical Minimum Keys for Text Entry](https://arxiv.org/abs/2606.11642)
*Naoki Kimura*
...
### [5] [Identifying cybersickness causes in virtual reality games using symbolic machine learning algorithms](https://arxiv.org/abs/2606.12214)
...
### [6] [Learning by Chatting? Investigating the Impact of Generative AI on Information Seeking and Learning](https://arxiv.org/abs/2606.11669)
...
### [7] [Understanding and Supporting Online Discussion with Opinionated Chatbots](https://arxiv.org/abs/2606.11693)
...
### [8] [Designing AI-Supported Focus Groups: A Role x Modality Playbook](https://arxiv.org/abs/2606.11835)
...
### [9] [PAPEL: A Collaborative System for Parental Guidance during Preschool Play-Based English Learning](https://arxiv.org/abs/2606.11896)
...
### [10] [Frozen Multimodal Embeddings for Personality and Cognitive Ability Assessment in Asynchronous Video Interviews](https://arxiv.org/abs/2606.11930)
...
### [11] [Somewhere Over the Desktop: A Research Agenda for Ubiquitous Analytics](https://arxiv.org/abs/2606.11980)
...
### [12] [Channels and Substrates: Distributed Cognition as an Interaction Model for Ubiquitous Analytics](https://arxiv.org/abs/2606.11986)
*Niklas Elmqvist,Panagiotis D. Ritsos,Peter W. S. Butcher*
...
### [13] [Multi-agent rendezvous in fluid flows via reinforcement learning](https://arxiv.org/abs/2606.11274)
...
### [14] [Phi-Actor-Critic: Steering General-Sum Games to Pareto-Efficient Correlated Equilibria](https://arxiv.org/abs/2606.11284)
...
### [15] [CCKS: Consensus-based Communication and Knowledge Sharing](https://arxiv.org/abs/2606.12281)
...
### [16] [A Zero-Shot Multi-Agent Framework for Human-Building Interaction via Programmatic Reasoning](https://arxiv.org/abs/2606.11354)
