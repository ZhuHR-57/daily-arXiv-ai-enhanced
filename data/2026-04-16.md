...
### [2] [From Seeing it to Experiencing it: Interactive Evaluation of Intersectional Voice Bias in Human-AI Speech Interaction](https://arxiv.org/abs/2604.13067)
...
### [3] [Inclusive Kitchen Design for Older Adults: Generative AI Visualizations to Support Mild Cognitive Impairment](https://arxiv.org/abs/2604.13203)
...
### [4] [Lazy or Efficient? Towards Accessible Eye-Tracking Event Detection Using LLMs](https://arxiv.org/abs/2604.13243)
...
### [5] [Does the TalkMoves Codebook Generalize to One-on-One Tutoring and Multimodal Interaction?](https://arxiv.org/abs/2604.13380)
...
### [6] [Young people's perceptions and recommendations for conversational generative artificial intelligence in youth mental health](https://arxiv.org/abs/2604.13381)
...
### [7] [Functional Emotions or Situational Contexts? A Discriminating Test from the Mythos Preview System Card](https://arxiv.org/abs/2604.13466)
*Hiranya V. Peiris*
...
### [8] [Nanomentoring: Investigating How Quickly People Can Help People Learn Feature-Rich Software](https://arxiv.org/abs/2604.13621)
...
### [9] [EMGFlow: Robust and Efficient Surface Electromyography Synthesis via Flow Matching](https://arxiv.org/abs/2604.13685)
...
### [10] [Cognitive Offloading in Agile Teams: How Artificial Intelligence Reshapes Risk Assessment and Planning Quality](https://arxiv.org/abs/2604.13814)
...
### [11] ["AI Psychosis" in Context: How Conversation History Shapes LLM Responses to Delusional Beliefs](https://arxiv.org/abs/2604.13860)
...
### [12] [Creo: From One-Shot Image Generation to Progressive, Co-Creative Ideation](https://arxiv.org/abs/2604.13956)
...
### [13] [Block-Based Pathfinding: A Minecraft System for Visualizing Graph Algorithms](https://arxiv.org/abs/2604.13957)
...
### [14] [Acts of Configuration: Rethinking Provenance, Temporality and Legitimacy in Post-Mortem Agents](https://arxiv.org/abs/2604.13996)
...
### [15] ["I'm Not Able to Be There for You": Emotional Labour, Responsibility, and AI in Peer Support](https://arxiv.org/abs/2604.14007)
...
### [16] [Embedded DNA Inference in In-Body Nanonetworks: Detection, Delay, and Communication Trade-Offs](https://arxiv.org/abs/2604.13306)
*Stefan Fischer*
...
### [17] [DTCO Exploration of NOR-Type IGZO FeFETs for Read-Dominated Memories](https://arxiv.org/abs/2604.13624)
...
### [18] [C$^2$T: Captioning-Structure and LLM-Aligned Common-Sense Reward Learning for Traffic--Vehicle Coordination](https://arxiv.org/abs/2604.13098)
...
### [20] [MIND: AI Co-Scientist for Material Research](https://arxiv.org/abs/2604.13699)
...
### [21] [[COMP25] The Automated Negotiating Agents Competition (ANAC) 2025 Challenges and Results](https://arxiv.org/abs/2604.13914)
...
### [22] [Fast Voxelization and Level of Detail for Microgeometry Rendering](https://arxiv.org/abs/2604.13191)
...
### [23] [Calibrated Abstention for Reliable TCR--pMHC Binding Prediction under Epitope Shift](https://arxiv.org/abs/2604.13254)
...
### [24] [A Unified Conditional Flow for Motion Generation, Editing, and Intra-Structural Retargeting](https://arxiv.org/abs/2604.13427)
