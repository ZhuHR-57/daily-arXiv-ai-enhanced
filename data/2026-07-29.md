...
### [1] [From sLLG to Fokker-Planck: Accurate WER Modeling for Non-Axisymmetric MRAM Devices](https://arxiv.org/abs/2607.25505)
...
### [3] [Game AI Not Fun? A Scoping Review and Meta-Analysis on the Differences in Enjoyment between Human and Computer Opponents](https://arxiv.org/abs/2607.24749)
*Ray Ito*
...
### [4] [Stop Writing for Me: Generative Refusal in AI Tools for Thought](https://arxiv.org/abs/2607.24751)
*Sora Kang*
...
### [5] [Development and applications of Generative AI in architectural design studios](https://arxiv.org/abs/2607.24752)
...
### [6] [Language as a Material Interface for Creative LLM Interaction](https://arxiv.org/abs/2607.24753)
...
### [7] [From Dyad to Triad: Eliciting XAI Requirements in Stroke Rehabilitation](https://arxiv.org/abs/2607.25423)
...
### [8] [CARE-MH: Towards Unified, Reproducible, and Comparable Evaluation of Mental Health LLMs](https://arxiv.org/abs/2607.24754)
...
### [9] [Patterns of Learner-AI Interaction and Academic Performance in an Object-Oriented Programming Course](https://arxiv.org/abs/2607.24755)
*Marina Lepp*
...
### [10] [What Gets Lost When Memory Becomes Media? Evaluating AI-Generated Oral History Visualization](https://arxiv.org/abs/2607.24756)
...
### [11] [From Idea to Classroom in Days: Using "Vibe Coding" to Create a Programming Process Visualizer from IDE Activity Logs](https://arxiv.org/abs/2607.24757)
...
### [12] [Verification Without Distrust: Reframing User-Side Oversight as Routine Epistemic Governance in Everyday Human-Chatbot Interaction](https://arxiv.org/abs/2607.24761)
*Aung Pyae*
...
### [13] [Empathy and the Human-Moment Gaps of AI Chatbots: Insights from Empathy Displacement Theory](https://arxiv.org/abs/2607.24775)
*Victor Frimpong*
...
### [14] [The AI Wave and the Reinvention of Game Discovery: Oversupply, Structural Correction, and Agentic Player-Game Matching](https://arxiv.org/abs/2607.25010)
...
### [15] [Extended Reality as a Mediation Layer for Situated Human Control in Human-Robot Teaming](https://arxiv.org/abs/2607.25047)
...
### [16] [ObjectEMS: Electrical Muscle Stimulation Without Electrodes on the User](https://arxiv.org/abs/2607.25084)
...
### [17] [Memdora: Designing Cognitively-Grounded Flashcard Interactions for AI-Powered Spaced Repetition](https://arxiv.org/abs/2607.25096)
*Ruiyang Zhang*
...
### [18] [UrbanTrace: LLM-Assisted Discovery and Semantics-Aware Integration of Spatial Data](https://arxiv.org/abs/2607.25124)
...
### [19] [Beyond the Post Hoc User Study: Modeling Visual Decision-Making with Active Inference](https://arxiv.org/abs/2607.25131)
...
### [20] [TailVis: Expressive Chart Refinement Preserving Data-Binding Integrity](https://arxiv.org/abs/2607.25386)
...
### [21] [Agentic AI Autonomy Assessment: A Decision-Support Framework Towards Governed Supply Chain Systems](https://arxiv.org/abs/2607.25405)
...
### [22] ["Dragon Slayer Becomes the Dragon": How Players Perceive and Respond to Inequality in the Game World of Whiteout Survival](https://arxiv.org/abs/2607.25574)
...
### [23] [BioDisclose: An Actionability-Aware Benchmark for Biomedical Safety under Adversarial Elicitation](https://arxiv.org/abs/2607.25700)
...
### [24] [AnnoBench: A Benchmark for Visualization Annotation Generation](https://arxiv.org/abs/2607.25911)
...
### [25] [Faster, Higher, Stronger? The Impact of GenAI on Knowledge Work Productivity - Evidence from the Field](https://arxiv.org/abs/2607.25922)
...
### [26] [Who is scientific code for? Maintaining human-readable landmarks in agent-written code](https://arxiv.org/abs/2607.25975)
*Elle O'Brien*
...
### [27] [LLM4OSC: Profile-Bound Natural Language Control with Deterministic Validation for Open Sound Control](https://arxiv.org/abs/2607.26024)
*Yuan-Yi Fan*
...
### [28] [Intrinsic and Triangulation-Agnostic Attention: A Simple and Powerful Approach for Learning on Meshes](https://arxiv.org/abs/2607.24954)
...
### [29] [Structuring Line Ensembles with Path-Integrated Fidelity and Structural Inconsistency Fields](https://arxiv.org/abs/2607.25121)
...
### [30] [Functionally Grading the Slicing Process by Compiling Design Intent into Slicer Projects](https://arxiv.org/abs/2607.25326)
...
### [31] [AVE-Compass: Towards Holistic Evaluation for Audio-Video Editing Abilities](https://arxiv.org/abs/2607.24821)
...
### [32] [Agentic AI-enabled discovery across large-scale sleep physiology](https://arxiv.org/abs/2607.25175)
...
### [33] [SafeFlow: Semantic Information-Flow Control for Blocking Malicious Propagation in Multi-Agent Systems](https://arxiv.org/abs/2607.25255)
...
### [34] [CoRenew: A large language model agent-based policy simulation platform for multifamily residential redevelopment](https://arxiv.org/abs/2607.25447)
...
### [35] [ARCHER: Agentic Rule and Compliance Harness for Executable Regulations](https://arxiv.org/abs/2607.25566)
...
### [36] [CHILL-Harness: Counterfactual Harness Learning for Efficient Reasoning in Long-Horizon Agents](https://arxiv.org/abs/2607.25825)
...
### [37] [Towards a Systems Foundation for Agentic Cloud Management](https://arxiv.org/abs/2607.25883)
