...
### [2] [SPP-SCL: Semi-Push-Pull Supervised Contrastive Learning for Image-Text Sentiment Analysis and Beyond](https://arxiv.org/abs/2602.20767)
...
### [3] [What Drives Students' Use of AI Chatbots? Technology Acceptance in Conversational AI](https://arxiv.org/abs/2602.20547)
...
### [4] [Rapid Testing, Duck Lips, and Tilted Cameras: Youth Everyday Algorithm Auditing Practices with Generative AI Filters](https://arxiv.org/abs/2602.20314)
...
### [5] [52-Hz Whale Song: An Embodied VR Experience for Exploring Misunderstanding and Empathy](https://arxiv.org/abs/2602.20348)
...
### [6] [Misty Forest VR: Turning Real ADHD Attention Patterns into Shared Momentum for Youth Collaboration](https://arxiv.org/abs/2602.20350)
...
### [7] [Hybrid LLM-Embedded Dialogue Agents for Learner Reflection: Designing Responsive and Theory-Driven Interactions](https://arxiv.org/abs/2602.20486)
...
### [8] [Changing the Optics: Comparing Traditional and Retrieval-Augmented GenAI E-Tutorials in Interdisciplinary Learning](https://arxiv.org/abs/2602.20544)
...
### [9] [Improving Data Quality via Pre-Task Participant Screening in Crowdsourced GUI Experiments](https://arxiv.org/abs/2602.20594)
...
### [10] [When LLMs Enter Everyday Feminism on Chinese Social Media: Opportunities and Risks for Women's Empowerment](https://arxiv.org/abs/2602.20876)
...
### [11] [InterPilot: Exploring the Design Space of AI-assisted Job Interview Support for HR Professionals](https://arxiv.org/abs/2602.20891)
...
### [12] [PaperTrail: A Claim-Evidence Interface for Grounding Provenance in LLM-based Scholarly Q&A](https://arxiv.org/abs/2602.21045)
...
### [13] [An Expert Schema for Evaluating Large Language Model Errors in Scholarly Question-Answering Systems](https://arxiv.org/abs/2602.21059)
...
### [14] ["Are You Sure?": An Empirical Study of Human Perception Vulnerability in LLM-Driven Agentic Systems](https://arxiv.org/abs/2602.21127)
...
### [15] [SparkMe: Adaptive Semi-Structured Interviewing for Qualitative Insight Discovery](https://arxiv.org/abs/2602.21136)
...
### [16] [Directly from Alpha to Omega: Controllable End-to-End Vector Floor Plan Generation](https://arxiv.org/abs/2602.20377)
