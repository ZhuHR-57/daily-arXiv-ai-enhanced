...
### [6] [General purpose graphical rendering on quantum devices with composable function systems](https://arxiv.org/abs/2608.04022)
...
### [7] [Toward Uncertainty Quantification in Modern Art](https://arxiv.org/abs/2608.04038)
...
### [8] [NuclearDiffusion: Text-to-Image Foundation Models for Learning Nuclear Energy Concepts](https://arxiv.org/abs/2608.04030)
...
### [9] [Modality Agreement- and Conflict-Aware Prototype Hypergraph Learning for Multimodal Intent Understanding](https://arxiv.org/abs/2608.04054)
...
### [10] [Echoes in the Sky: Computational Thematic Analysis of Online Public Discourse on Bluesky Across Trump's Reelection](https://arxiv.org/abs/2608.04120)
...
### [11] [Enacting Constructive Conflicts with AI Agents to Enhance Reconsideration among Novice Interaction Designers](https://arxiv.org/abs/2608.04166)
...
### [12] [Revisiting Channel Effectiveness: A Multi-Dimensional Evaluation with Primitive Visual Stimuli](https://arxiv.org/abs/2608.04435)
...
### [13] [Compass: Continuously Aligning Social Media Feeds via In-Situ Reflections](https://arxiv.org/abs/2608.04274)
...
### [14] [Exploring Cross-Reality Transitions between Projections and Head-Mounted Displays for Immersive Digital Art](https://arxiv.org/abs/2608.04971)
...
### [19] [Super-Gaussian: Interactive Scene Editing for 3D Gaussian Splatting and NLI-Based Volume Visualization in Virtual Reality](https://arxiv.org/abs/2608.04475)
...
### [20] [Emotion Dynamics in Social Deception Games: Analysis of Professional and Nonprofessional Players through Electrodermal Activity in Werewolf Games](https://arxiv.org/abs/2608.04605)
...
### [21] [LiverPlan: A Stage-Adaptive Immersive Visual Analytics Framework for Anatomical Liver Surgical Planning](https://arxiv.org/abs/2608.04707)
...
### [22] [Reference-Based Manipulation: A Framework and Pipeline for Multimodal Spatial Reasoning](https://arxiv.org/abs/2608.04798)
...
### [23] [Investigating Click Behaviors On Google Search Result Pages That Produce an AI Overview](https://arxiv.org/abs/2608.04831)
...
### [24] [AutoCue: Multimodal LLM-Assisted Externalization of Implicit Inputs as Instructional Visual Cues in Screencast Tutorials](https://arxiv.org/abs/2608.04910)
...
### [25] [Transition Techniques for Externally-Guided Multi-Scale Viewpoint Changes](https://arxiv.org/abs/2608.04912)
...
### [26] [Reply, Delete, or Ignore? Examining How Content Creators Perceive and Select Comment Moderation Strategies](https://arxiv.org/abs/2608.04951)
...
### [27] [ArtAnno: Annotating Implicit Semantics in Artworks through LLM Agent-Driven Bidirectional Human-AI Augmentation](https://arxiv.org/abs/2608.05026)
...
### [28] [DeepConnect: A Visual Analytics System for Bridging Interdisciplinary Research Collaborations](https://arxiv.org/abs/2608.05134)
...
### [29] [Scale-CDA: A Scalable Prototype to Democratize AI-Assisted Cooperative Driving Automation (CDA) for Production Cars](https://arxiv.org/abs/2608.04235)
...
### [30] [Toward Blockage-Resilient 6G-V2X Connectivity: Semi-Distributed Bandit with Dynamic Arm Set for mmWave HetNets](https://arxiv.org/abs/2608.04852)
